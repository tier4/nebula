...
drivers::PclPointCloudXYZIRADTPtr Pandar40Decoder::getPointcloud() { return scan_pc_; }

void Pandar40Decoder::unpack(const pandar_msgs::msg::PandarScan & pandar_scan)
{
...
drivers::PclPointCloudXYZIRADTPtr Pandar40Decoder::build_point(int block_id, int unit_id, uint8_t return_type)
{
...
drivers::PclPointCloudXYZIRADTPtr Pandar40Decoder::convert(const int block_id)
{
  drivers::PclPointCloudXYZIRADTPtr block_pc(new PclPointCloudXYZIRAD);
...
drivers::PclPointCloudXYZIRADTPtr Pandar40Decoder::convert_dual(const int block_id)
{
