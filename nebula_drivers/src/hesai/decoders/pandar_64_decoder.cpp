...
nebula::drivers::PclPointCloudXYZIRADTPtr Pandar64Decoder::getPointcloud() { return scan_pc_; }

void Pandar64Decoder::unpack(const pandar_msgs::msg::PandarScan & pandar_scan)
{
...
//  if (!dual_return) {
//    if (
//      (packet_.return_mode == STRONGEST_RETURN && return_mode_ != ReturnMode::STRONGEST) ||
...
nebula::drivers::PclPointCloudXYZIRADTPtr Pandar64Decoder::build_point(int block_id, int unit_id, uint8_t return_type)
{
...
nebula::drivers::PclPointCloudXYZIRADTPtr Pandar64Decoder::convert(const int block_id)
{
//  PointcloudXYZIRADT block_pc(new pcl::PointCloud<PclPointCloudXYZIRADTPtr>);
//
//  const auto & block = packet_.blocks[block_id];
...
//      block_id, unit_id,
//      (packet_.return_mode == STRONGEST_RETURN) ? ReturnType::SINGLE_STRONGEST
//                                                : ReturnType::SINGLE_LAST));
//  }
//  return block_pc;
}

nebula::drivers::PclPointCloudXYZIRADTPtr Pandar64Decoder::convert_dual(const int block_id)
{
...
//        build_point(even_block_id, unit_id, ReturnType::SINGLE_STRONGEST));
...
//        if (even_usable) {
//          block_pc->points.emplace_back(
//            build_point(even_block_id, unit_id, ReturnType::DUAL_FIRST));
//        }
//        if (odd_usable) {
