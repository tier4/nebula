...
nebula::drivers::PclPointCloudXYZIRADTPtr PandarQTDecoder::getPointcloud() { return scan_pc_; }

void PandarQTDecoder::unpack(const pandar_msgs::msg::PandarScan & pandar_scan)
{
...
//  if (!dual_return) {
//    if (
//      (packet_.return_mode == FIRST_RETURN && return_mode_ != ReturnMode::FIRST) ||
...
nebula::drivers::PclPointCloudXYZIRADTPtr PandarQTDecoder::build_point(int block_id, int unit_id, uint8_t return_type)
{
...
nebula::drivers::PclPointCloudXYZIRADTPtr PandarQTDecoder::convert(const int block_id)
{
...
nebula::drivers::PclPointCloudXYZIRADTPtr PandarQTDecoder::convert_dual(const int block_id)
{
