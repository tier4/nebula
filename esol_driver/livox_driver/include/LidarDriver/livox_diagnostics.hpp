...
enum class LivoxTimeSyncStatus : uint8_t {
  ...
  kAbnormal     /**< System time synchronization is abnormal (The highest priority synchronization
                   signal is abnormal) */
};
...
/**
 * Converts the Raw 32 bit word contained in the Ethernet Packet received from the sensor to a
 * LivoxDiagnosticsSensorStatus object.
