...
#ifndef NEBULA_VELODYNE_COMMON__VELODYNE_STATUS_HPP_
#define NEBULA_VELODYNE_COMMON__VELODYNE_STATUS_HPP_
...
#endif  // NEBULA_VELODYNE_COMMON__VELODYNE_STATUS_HPP_
