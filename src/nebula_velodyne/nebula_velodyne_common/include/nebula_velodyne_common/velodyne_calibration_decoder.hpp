...
#ifndef NEBULA_VELODYNE_COMMON__VELODYNE_CALIBRATION_DECODER_HPP_
#define NEBULA_VELODYNE_COMMON__VELODYNE_CALIBRATION_DECODER_HPP_
...
#endif  // NEBULA_VELODYNE_COMMON__VELODYNE_CALIBRATION_DECODER_HPP_
