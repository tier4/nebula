...
struct OUSTER_API_CLASS SensorScanSourceOptions : private ScanSourceOptions
{
   ...
   */
  OUSTER_API_FUNCTION
  SensorScanSourceOptions(const ScanSourceOptions & o) : ScanSourceOptions(o) {}
...
: public ouster::sdk::core::ScanSource,
  ouster::sdk::impl::ScanSourceBuilder<ouster::sdk::core::IoType::SENSOR, SensorScanSource>
{
...
private:
  ...
  std::deque<std::pair<int, std::unique_ptr<ouster::sdk::core::LidarScan>>> buffer_;
