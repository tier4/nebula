...
FieldInfo field_info(size_t bit_start, size_t bit_size, size_t upshift = 0)
{
  ...
  if (needs_bits > 64) {
    throw std::invalid_argument("failed creating FieldInfo: value cannot store more than 64 bits");
  }
...
Table<UDPProfileLidar, ProfileEntry, MAX_NUM_PROFILES> OUSTER_API_FUNCTION profiles{{
  ...
  {UDPProfileLidar::RNG15_RFL8_NIR8_ZONE16, {ZM_LB_FIELD_INFO.data(), ZM_LB_FIELD_INFO.size(), 8}},
  {UDPProfileLidar::RNG19_RFL8_SIG16_NIR16_ZONE16,
   {ZM_SINGLE_FIELD_INFO.data(), ZM_SINGLE_FIELD_INFO.size(), 12}},
  {UDPProfileLidar::RNG15_RFL8_WIN8, {LB_WINDOW_FIELD_INFO.data(), LB_WINDOW_FIELD_INFO.size(), 4}},
}};
...
struct PacketFormat::Impl
{
  ...
  Impl(const DataFormat & format) : Impl()
  {
    ...
    const auto & entry = impl::lookup_profile_entry(format.udp_profile_lidar);
    ...
    col_size = col_header_size + format.pixels_per_column * channel_data_size + col_footer_size;
    lidar_packet_size =
      packet_header_size + format.columns_per_packet * col_size + packet_footer_size;
...
void PacketFormat::block_field(
  Eigen::Ref<img_t<T>> field, const std::string & chan, const uint8_t * packet_buf) const
{
...
template <typename T>
void PacketFormat::col_field(
  const uint8_t * col_buf, const std::string & chan, T * dst, int dst_stride) const
{
  impl::FieldInfo field_info = impl_->fields.at(chan);
...
template void PacketFormat::block_field<uint8_t, 4>(
  Eigen::Ref<img_t<uint8_t>> field, const std::string & chan, const uint8_t * packet_buf) const;
template void PacketFormat::block_field<uint16_t, 4>(
  Eigen::Ref<img_t<uint16_t>> field, const std::string & chan, const uint8_t * packet_buf) const;
template void PacketFormat::block_field<uint32_t, 4>(
  Eigen::Ref<img_t<uint32_t>> field, const std::string & chan, const uint8_t * packet_buf) const;
template void PacketFormat::block_field<uint64_t, 4>(
  Eigen::Ref<img_t<uint64_t>> field, const std::string & chan, const uint8_t * packet_buf) const;
template void PacketFormat::block_field<int8_t, 4>(
  Eigen::Ref<img_t<int8_t>> field, const std::string & chan, const uint8_t * packet_buf) const;
template void PacketFormat::block_field<int16_t, 4>(
  Eigen::Ref<img_t<int16_t>> field, const std::string & chan, const uint8_t * packet_buf) const;
template void PacketFormat::block_field<int32_t, 4>(
  Eigen::Ref<img_t<int32_t>> field, const std::string & chan, const uint8_t * packet_buf) const;
template void PacketFormat::block_field<int64_t, 4>(
  Eigen::Ref<img_t<int64_t>> field, const std::string & chan, const uint8_t * packet_buf) const;
template void PacketFormat::block_field<float, 4>(
  Eigen::Ref<img_t<float>> field, const std::string & chan, const uint8_t * packet_buf) const;
template void PacketFormat::block_field<double, 4>(
  Eigen::Ref<img_t<double>> field, const std::string & chan, const uint8_t * packet_buf) const;
...
template void PacketFormat::col_field(const uint8_t *, const std::string &, uint8_t *, int) const;
template void PacketFormat::col_field(const uint8_t *, const std::string &, uint16_t *, int) const;
template void PacketFormat::col_field(const uint8_t *, const std::string &, uint32_t *, int) const;
template void PacketFormat::col_field(const uint8_t *, const std::string &, uint64_t *, int) const;
template void PacketFormat::col_field(const uint8_t *, const std::string &, int8_t *, int) const;
template void PacketFormat::col_field(const uint8_t *, const std::string &, int16_t *, int) const;
template void PacketFormat::col_field(const uint8_t *, const std::string &, int32_t *, int) const;
template void PacketFormat::col_field(const uint8_t *, const std::string &, int64_t *, int) const;
template void PacketFormat::col_field(const uint8_t *, const std::string &, float *, int) const;
template void PacketFormat::col_field(const uint8_t *, const std::string &, double *, int) const;
...
const uint8_t * PacketFormat::nth_col(int col_idx, const uint8_t * lidar_buf) const
{
...
const uint8_t * PacketFormat::imu_nth_measurement(int meas_idx, const uint8_t * imu_buf) const
{
...
{
  return std::tie(
           lhs.pixels_per_column, lhs.columns_per_packet, lhs.columns_per_frame,
         ...
         std::tie(
           rhs.pixels_per_column, rhs.columns_per_packet, rhs.columns_per_frame,
...
namespace impl
{
PacketWriter::PacketWriter(const PacketFormat & packet_format) : PacketFormat(packet_format)
{
}
...
void PacketWriter::set_col_timestamp(uint8_t * col_buf, uint64_t timestamp) const
{
  impl_->col_timestamp_info.set(col_buf, timestamp);
}

void PacketWriter::set_col_measurement_id(uint8_t * col_buf, uint16_t m_id) const
{
...
void PacketWriter::set_packet_type(uint8_t * packet_buf, uint16_t packet_type) const
{
  impl_->packet_type_info.set(packet_buf, packet_type);
}

void PacketWriter::set_prod_sn(uint8_t * lidar_buf, uint64_t serial_number) const
{
  impl_->prod_sn_info.set(lidar_buf, serial_number);
}

void PacketWriter::set_alert_flags(uint8_t * lidar_buf, uint8_t alert_flags) const
{
...
void PacketWriter::set_shutdown_countdown(uint8_t * lidar_buf, uint8_t shutdown_countdown) const
{
...
template <typename T>
void PacketWriter::set_block(
  Eigen::Ref<const img_t<T>> field, const std::string & chan, uint8_t * lidar_buf) const
{
...
template void PacketWriter::set_block(
  Eigen::Ref<const img_t<uint8_t>> field, const std::string & chan, uint8_t * lidar_buf) const;
template void PacketWriter::set_block(
  Eigen::Ref<const img_t<uint16_t>> field, const std::string & chan, uint8_t * lidar_buf) const;
template void PacketWriter::set_block(
  Eigen::Ref<const img_t<uint32_t>> field, const std::string & chan, uint8_t * lidar_buf) const;
template void PacketWriter::set_block(
  Eigen::Ref<const img_t<uint64_t>> field, const std::string & chan, uint8_t * lidar_buf) const;
template void PacketWriter::set_block(
  Eigen::Ref<const img_t<int8_t>> field, const std::string & chan, uint8_t * lidar_buf) const;
template void PacketWriter::set_block(
  Eigen::Ref<const img_t<int16_t>> field, const std::string & chan, uint8_t * lidar_buf) const;
template void PacketWriter::set_block(
  Eigen::Ref<const img_t<int32_t>> field, const std::string & chan, uint8_t * lidar_buf) const;
template void PacketWriter::set_block(
  Eigen::Ref<const img_t<int64_t>> field, const std::string & chan, uint8_t * lidar_buf) const;
template void PacketWriter::set_block(
  Eigen::Ref<const img_t<float>> field, const std::string & chan, uint8_t * lidar_buf) const;
template void PacketWriter::set_block(
  Eigen::Ref<const img_t<double>> field, const std::string & chan, uint8_t * lidar_buf) const;

template <typename T>
void PacketWriter::unpack_raw_headers(Eigen::Ref<const img_t<T>> field, uint8_t * lidar_buf) const
{
...
uint8_t * PacketWriter::imu_nth_measurement(int meas_idx, uint8_t * imu_buf) const
{
  return const_cast<uint8_t *>(PacketFormat::imu_nth_measurement(meas_idx, imu_buf));
}

uint8_t * PacketWriter::zone_nth_measurement(int meas_idx, uint8_t * zone_buf) const
{
  return const_cast<uint8_t *>(PacketFormat::zone_nth_measurement(meas_idx, zone_buf));
}
...
void PacketWriter::set_imu_nmea_sentence(uint8_t * imu_buf, const std::string & sentence) const
{
...
void PacketWriter::set_imu_nmea_sentence(uint8_t * imu_buf, const char * ptr) const
{
  char * start = reinterpret_cast<char *>(imu_buf) + impl_->packet_header_size + 8;
...
void PacketWriter::set_zone_timestamp(uint8_t * zone_buf, uint64_t timestamp) const
{
  impl_->zone_timestamp_info.set(zone_buf, timestamp);
}

void PacketWriter::set_live_zoneset_hash(uint8_t * zone_buf, const uint8_t * hash) const
{
...
void PacketWriter::set_zone_state(uint8_t * zone_m_ptr, const ZoneState & zone) const
{
...
const uint8_t * PacketFormat::zone_nth_measurement(int meas_idx, const uint8_t * imu_buf) const
{
  return imu_buf + impl_->zone_measurement_offset + (meas_idx * impl_->zone_measurement_size);
}
