...
void AutoExposure::operator()(Eigen::Ref<img_t<float>> image, bool update_state)
{
...
template <typename T>
void BeamUniformityCorrector::update(Eigen::Ref<img_t<T>> image, bool update_state)
{
...
void BeamUniformityCorrector::operator()(Eigen::Ref<img_t<float>> image, bool update_state)
{
  update(image, update_state);
}

void BeamUniformityCorrector::operator()(Eigen::Ref<img_t<double>> image, bool update_state)
{
  update(image, update_state);
}
