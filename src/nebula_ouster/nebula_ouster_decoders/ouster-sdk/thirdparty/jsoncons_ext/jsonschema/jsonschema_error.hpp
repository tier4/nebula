...
public:
  validation_output(
    std::string keyword, std::string schema_path, std::string instance_location,
    std::string message)
  ...
  validation_output(
    const std::string & keyword, const std::string & schema_path,
    const std::string & instance_location, const std::string & message,
  ...
  const std::vector<validation_output> & nested_errors() const { return nested_errors_; }
};
