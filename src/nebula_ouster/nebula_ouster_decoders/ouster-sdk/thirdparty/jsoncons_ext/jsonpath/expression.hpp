...
public:
  ...
  using pointer = typename std::conditional<
    ...
    typename Json::const_pointer, typename Json::pointer>::type;
...
public:
  value_or_pointer(value_type && val) : is_value_(true), val_(std::move(val)) {}

  value_or_pointer(pointer ptr) : is_value_(false), ptr_(std::move(ptr)) {}

  value_or_pointer(value_or_pointer && other) noexcept : is_value_(other.is_value_)
  {
    if (is_value_) {
  ...
  reference value() { return is_value_ ? val_ : *ptr_; }

  pointer ptr() { return is_value_ ? &val_ : ptr_; }
};
...
public:
  ...
  parameter(value_or_pointer<Json, JsonReference> && data) noexcept : data_(nullptr)
  {
  ...
  const Json & value() const { return data_.is_value_ ? data_.val_ : *data_.ptr_; }
};
...
public:
  ...
  using function_type =
    std::function<value_type(jsoncons::span<const parameter_type>, std::error_code & ec)>;
  ...
  custom_function(
    const string_type & function_name, const optional<std::size_t> & arity, const function_type & f)
  : function_name_(function_name), arity_(arity), f_(f)
  {
  }

  custom_function(string_type && function_name, optional<std::size_t> && arity, function_type && f)
  : function_name_(std::move(function_name)), arity_(std::move(arity)), f_(std::move(f))
  {
  }
  ...
  const string_type & name() const { return function_name_; }

  optional<std::size_t> arity() const { return arity_; }

  const function_type & function() const { return f_; }
};
...
public:
  void register_function(
    const string_type & name, jsoncons::optional<std::size_t> arity, const function_type & f)
  {
...
struct unary_operator
{
  ...
  std::size_t precedence_level() const { return precedence_level_; }
  bool is_right_associative() const { return is_right_associative_; }
...
{
  return (
    (val.is_array() && val.empty()) || (val.is_object() && val.empty()) ||
    (val.is_string() && val.as_string_view().empty()) || (val.is_bool() && !val.as_bool()) ||
    val.is_null());
}
...
{
public:
  unary_not_operator() : unary_operator<Json, JsonReference>(1, true) {}
...
{
public:
  unary_minus_operator() : unary_operator<Json, JsonReference>(1, true) {}
...
public:
  ...
  : unary_operator<Json, JsonReference>(2, true), pattern_(std::move(pattern))
  {
  }
  ...
  Json evaluate(JsonReference val, std::error_code &) const override
  {
    ...
    return std::regex_search(val.as_string(), pattern_) ? Json(true, semantic_tag::none)
                                                        : Json(false, semantic_tag::none);
  }
};
...
struct binary_operator
{
  ...
  virtual Json evaluate(
    JsonReference, JsonReference,

    std::error_code &) const = 0;

  virtual std::string to_string(int = 0) const { return "binary operator"; }
...
{
public:
  or_operator() : binary_operator<Json, JsonReference>(9) {}
...
{
public:
  and_operator() : binary_operator<Json, JsonReference>(8) {}
...
{
public:
  eq_operator() : binary_operator<Json, JsonReference>(6) {}
...
{
public:
  ne_operator() : binary_operator<Json, JsonReference>(6) {}
...
{
public:
  lt_operator() : binary_operator<Json, JsonReference>(5) {}
...
{
public:
  lte_operator() : binary_operator<Json, JsonReference>(5) {}
...
{
public:
  gt_operator() : binary_operator<Json, JsonReference>(5) {}
...
{
public:
  gte_operator() : binary_operator<Json, JsonReference>(5) {}
...
{
public:
  plus_operator() : binary_operator<Json, JsonReference>(4) {}
...
{
public:
  minus_operator() : binary_operator<Json, JsonReference>(4) {}
...
{
public:
  mult_operator() : binary_operator<Json, JsonReference>(3) {}
...
{
public:
  div_operator() : binary_operator<Json, JsonReference>(3) {}
...
{
public:
  modulus_operator() : binary_operator<Json, JsonReference>(3) {}
...
public:
  ...
  function_base(jsoncons::optional<std::size_t> arg_count) : arg_count_(arg_count) {}

  virtual ~function_base() noexcept = default;

  jsoncons::optional<std::size_t> arity() const { return arg_count_; }

  virtual value_type evaluate(
    const std::vector<parameter_type> & args, std::error_code & ec) const = 0;
...
public:
  decorator_function(jsoncons::optional<std::size_t> arity, const function_type & f)
  : function_base<Json>(arity), f_(f)
  {
  }

  value_type evaluate(const std::vector<parameter_type> & args, std::error_code & ec) const override
  {
    return f_(args, ec);
  }
};
...
public:
  ...
  contains_function() : function_base<Json>(2) {}
  ...
  value_type evaluate(const std::vector<parameter_type> & args, std::error_code & ec) const override
  {
    ...
    switch (arg0.type()) {
      ...
      case json_type::string_value: {
        ...
        return sv0.find(sv1) != string_view_type::npos ? value_type(true, semantic_tag::none)
                                                       : value_type(false, semantic_tag::none);
      }
      default: {
        ec = jsonpath_errc::invalid_type;
        return value_type::null();
...
public:
  ...
  ends_with_function() : function_base<Json>(2) {}
...
public:
  ...
  starts_with_function() : function_base<Json>(2) {}
...
public:
  ...
  sum_function() : function_base<Json>(1) {}
...
public:
  ...
  tokenize_function(const allocator_type & alloc) : function_base<Json>(2), alloc_(alloc) {}
  ...
  value_type evaluate(const std::vector<parameter_type> & args, std::error_code & ec) const override
  {
    ...
    std::regex_token_iterator<typename string_type::const_iterator> rit(
      s0.begin(), s0.end(), pieces_regex, -1);
...
public:
  ...
  ceil_function() : function_base<Json>(1) {}
...
public:
  ...
  floor_function() : function_base<Json>(1) {}
...
public:
  ...
  to_number_function() : function_base<Json>(1) {}
...
public:
  ...
  prod_function() : function_base<Json>(1) {}
...
public:
  ...
  avg_function() : function_base<Json>(1) {}
...
public:
  ...
  min_function() : function_base<Json>(1) {}
...
public:
  ...
  max_function() : function_base<Json>(1) {}
...
public:
  ...
  abs_function() : function_base<Json>(1) {}
  ...
  value_type evaluate(const std::vector<parameter_type> & args, std::error_code & ec) const override
  {
    ...
    switch (arg0.type()) {
      case json_type::uint64_value:
        return arg0;
      case json_type::int64_value: {
        return arg0.template as<int64_t>() >= 0
                 ? arg0
                 : value_type(std::abs(arg0.template as<int64_t>()), semantic_tag::none);
      }
      case json_type::double_value: {
        return arg0.template as<double>() >= 0
                 ? arg0
                 : value_type(std::abs(arg0.template as<double>()), semantic_tag::none);
      }
      default: {
        ec = jsonpath_errc::invalid_type;
        return value_type::null();
...
public:
  ...
  length_function() : function_base<Json>(1) {}
...
public:
  ...
  keys_function(const allocator_type & alloc) : function_base<Json>(1), alloc_(alloc) {}
...
struct path_value_pair
{
  ...
  using value_type = Json;
  using reference = JsonReference;
  using value_pointer = typename std::conditional<
    std::is_const<typename std::remove_reference<JsonReference>::type>::value,
    typename Json::const_pointer, typename Json::pointer>::type;
  ...
  path_node_type path() const { return *path_ptr_; }

  reference value() { return *value_ptr_; }
};
...
{
  bool operator()(
    const path_value_pair<Json, JsonReference> & lhs,
...
public:
  ...
  const path_node_type & last() const { return *last_ptr_; }

  reference value() const { return *value_ptr_; }
};
...
public:
  ...
  path_value_receiver(const allocator_type & alloc) : alloc_(alloc) {}
...
public:
  ...
  bool is_cached(std::size_t id) const { return cache_.find(id) != cache_.end(); }
  void add_to_cache(std::size_t id, reference val) { cache_.emplace(id, std::addressof(val)); }
  reference retrieve_from_cache(std::size_t id) { return *cache_[id]; }
  ...
  const string_type & length_label() const { return length_label_; }
...
{
  bool operator()(
    const path_value_pair<Json, JsonReference> & a,
    const path_value_pair<Json, JsonReference> & b) const
  {
    return *(a.ptr) < *(b.ptr);
  }
};
...
public:
  ...
  jsonpath_selector(bool is_path, std::size_t precedence_level = 0)
  : is_path_(is_path), precedence_level_(precedence_level)
  {
  }
  ...
  bool is_right_associative() const { return true; }

  virtual void select(
    dynamic_resources<Json, JsonReference> & resources, reference root,
    const path_node_type & base_path, reference val, node_receiver_type & receiver,
    result_options options) const = 0;

  virtual reference evaluate(
    dynamic_resources<Json, JsonReference> & resources, reference root,
    const path_node_type & base_path, reference current, result_options options,
    std::error_code & ec) const = 0;

  virtual void append_selector(jsonpath_selector *) {}

  virtual std::string to_string(int = 0) const { return std::string(); }
};
...
struct static_resources
{
  ...
  static_resources(const allocator_type & alloc = allocator_type()) : alloc_(alloc)
  {
    functions_.emplace(
      string_type{JSONCONS_CSTRING_CONSTANT(char_type, "abs"), alloc_},
      jsoncons::make_unique<abs_function<Json>>());
    functions_.emplace(
      string_type{JSONCONS_CSTRING_CONSTANT(char_type, "contains"), alloc_},
      jsoncons::make_unique<contains_function<Json>>());
    functions_.emplace(
      string_type{JSONCONS_CSTRING_CONSTANT(char_type, "starts_with"), alloc_},
      jsoncons::make_unique<starts_with_function<Json>>());
    functions_.emplace(
      string_type{JSONCONS_CSTRING_CONSTANT(char_type, "ends_with"), alloc_},
      jsoncons::make_unique<ends_with_function<Json>>());
    functions_.emplace(
      string_type{JSONCONS_CSTRING_CONSTANT(char_type, "ceil"), alloc_},
      jsoncons::make_unique<ceil_function<Json>>());
    functions_.emplace(
      string_type{JSONCONS_CSTRING_CONSTANT(char_type, "floor"), alloc_},
      jsoncons::make_unique<floor_function<Json>>());
    functions_.emplace(
      string_type{JSONCONS_CSTRING_CONSTANT(char_type, "to_number"), alloc_},
      jsoncons::make_unique<to_number_function<Json>>());
    functions_.emplace(
      string_type{JSONCONS_CSTRING_CONSTANT(char_type, "sum"), alloc_},
      jsoncons::make_unique<sum_function<Json>>());
    functions_.emplace(
      string_type{JSONCONS_CSTRING_CONSTANT(char_type, "prod"), alloc_},
      jsoncons::make_unique<prod_function<Json>>());
    functions_.emplace(
      string_type{JSONCONS_CSTRING_CONSTANT(char_type, "avg"), alloc_},
      jsoncons::make_unique<avg_function<Json>>());
    functions_.emplace(
      string_type{JSONCONS_CSTRING_CONSTANT(char_type, "min"), alloc_},
      jsoncons::make_unique<min_function<Json>>());
    functions_.emplace(
      string_type{JSONCONS_CSTRING_CONSTANT(char_type, "max"), alloc_},
      jsoncons::make_unique<max_function<Json>>());
    functions_.emplace(
      string_type{JSONCONS_CSTRING_CONSTANT(char_type, "length"), alloc_},
      jsoncons::make_unique<length_function<Json>>());
    functions_.emplace(
      string_type{JSONCONS_CSTRING_CONSTANT(char_type, "keys"), alloc_},
      jsoncons::make_unique<keys_function<Json>>(alloc_));
#if defined(JSONCONS_HAS_STD_REGEX)
    functions_.emplace(
      string_type{JSONCONS_CSTRING_CONSTANT(char_type, "tokenize"), alloc_},
      jsoncons::make_unique<tokenize_function<Json>>(alloc_));
#endif
    functions_.emplace(
      string_type{JSONCONS_CSTRING_CONSTANT(char_type, "count"), alloc_},
      jsoncons::make_unique<length_function<Json>>());
  }

  static_resources(
    const custom_functions<Json> & functions, const allocator_type & alloc = allocator_type())
  : static_resources(alloc)
  {
    for (const auto & item : functions) {
      custom_functions_.emplace(
        item.name(),
  ...
  const unary_operator<Json, JsonReference> * get_regex_operator(
    std::basic_regex<char_type> && pattern)
  {
    unary_operators_.push_back(
      jsoncons::make_unique<regex_operator<Json, JsonReference>>(std::move(pattern)));
...
public:
  ...
  virtual value_type evaluate(
    ...
    reference val, result_options options, std::error_code & ec) const = 0;
...
public:
  ...
  : token_kind_(jsonpath_token_kind::unary_operator), unary_operator_(expr)
  {
  }

  token(const binary_operator<Json, JsonReference> * expr) noexcept
  : token_kind_(jsonpath_token_kind::binary_operator), binary_operator_(expr)
  {
  }

  token(current_node_arg_t) noexcept : token_kind_(jsonpath_token_kind::current_node) {}

  token(root_node_arg_t) noexcept : token_kind_(jsonpath_token_kind::root_node) {}

  token(end_function_arg_t) noexcept : token_kind_(jsonpath_token_kind::end_function) {}

  token(separator_arg_t) noexcept : token_kind_(jsonpath_token_kind::separator) {}

  token(lparen_arg_t) noexcept : token_kind_(jsonpath_token_kind::lparen) {}

  token(rparen_arg_t) noexcept : token_kind_(jsonpath_token_kind::rparen) {}

  token(begin_union_arg_t) noexcept : token_kind_(jsonpath_token_kind::begin_union) {}

  token(end_union_arg_t) noexcept : token_kind_(jsonpath_token_kind::end_union) {}

  token(begin_filter_arg_t) noexcept : token_kind_(jsonpath_token_kind::begin_filter) {}

  token(end_filter_arg_t) noexcept : token_kind_(jsonpath_token_kind::end_filter) {}

  token(begin_expression_arg_t) noexcept : token_kind_(jsonpath_token_kind::begin_expression) {}
  ...
  token(selector_type * selector) : token_kind_(jsonpath_token_kind::selector), selector_(selector)
  {
  }
  ...
  : token_kind_(jsonpath_token_kind::function), function_(function)
  {
  }

  token(argument_arg_t) noexcept : token_kind_(jsonpath_token_kind::argument) {}
  ...
  token(token && other) noexcept { construct(std::move(other)); }
  ...
  ~token() noexcept { destroy(); }

  jsonpath_token_kind token_kind() const { return token_kind_; }

  bool is_lparen() const { return token_kind_ == jsonpath_token_kind::lparen; }

  bool is_rparen() const { return token_kind_ == jsonpath_token_kind::rparen; }

  bool is_current_node() const { return token_kind_ == jsonpath_token_kind::current_node; }
  ...
  {
    return token_kind_ == jsonpath_token_kind::function ? function_->arity()
                                                        : jsoncons::optional<std::size_t>();
  }
...
public:
  ...
  using reference_arg_type = typename std::conditional<
    std::is_const<typename std::remove_reference<JsonReference>::type>::value,
...
public:
  ...
  Json evaluate(
    dynamic_resources<Json, JsonReference> & resources, reference root, const path_node_type & path,
    reference instance, result_options options) const
  {
    ...
    if ((options & result_options::path) == result_options::path) {
      ...
      auto callback = [&result](const path_node_type &, reference val) { result.push_back(val); };
      evaluate(resources, root, path, instance, callback, options);
    }
  ...
  typename std::enable_if<
    extension_traits::is_binary_function_object<Callback, const path_node_type &, reference>::value,
    void>::type
  evaluate(
    dynamic_resources<Json, JsonReference> & resources, reference root, const path_node_type & path,
    reference current, Callback callback, result_options options) const
  {
    std::error_code ec;

    options |= required_options_;

    const result_options require_more =
      result_options::nodups | result_options::sort | result_options::sort_descending;
    ...
    if (selector_ != nullptr && (options & require_more) != result_options()) {
      ...
      if (
        receiver.nodes.size() > 1 && (options & result_options::nodups) == result_options::nodups) {
        if ((options & result_options::sort_descending) == result_options::sort_descending) {
          auto last = std::unique(
            receiver.nodes.rbegin(), receiver.nodes.rend(), path_value_pair_equal_type());
          ...
          auto last =
            std::unique(receiver.nodes.begin(), receiver.nodes.end(), path_value_pair_equal_type());
          ...
          for (auto && node : receiver.nodes) {
            auto it =
              std::lower_bound(index.begin(), index.end(), node, path_value_pair_less_type());
...
public:
  ...
  using reference_arg_type = typename std::conditional<
    std::is_const<typename std::remove_reference<reference>::type>::value, const_reference_arg_t,
    reference_arg_t>::type;
  using path_node_type = basic_path_node<typename Json::char_type>;
...
public:
  ...
  expression(expression && expr) : token_list_(std::move(expr.token_list_)) {}

  expression(std::vector<token_type> && token_stack) : token_list_(std::move(token_stack)) {}

  expression & operator=(expression && expr) = default;

  value_type evaluate(
    dynamic_resources<Json, reference> & resources, reference root, reference current,
    result_options options, std::error_code & ec) const override
  {
      ...
      for (auto & tok : token_list_) {
        ...
        switch (tok.token_kind()) {
          ...
          case jsonpath_token_kind::selector: {
            ...
            reference val =
              tok.selector_->evaluate(resources, root, path_node_type{}, item.value(), options, ec);
