...
enum class operator_kind {
  default_op,  // Identifier, CurrentNode, Index, MultiSelectList, MultiSelectHash,
               // FunctionExpression
  projection_op,
...
struct slice
{
  ...
  slice() : start_(), stop_(), step_(1) {}

  slice(
    const jsoncons::optional<int64_t> & start, const jsoncons::optional<int64_t> & end,
    int64_t step)
  : start_(start), stop_(end), step_(step)
  {
  }

  slice(const slice & other) : start_(other.start_), stop_(other.stop_), step_(other.step_) {}
...
public:
  ...
  {
    return (ref.is_array() && ref.empty()) || (ref.is_object() && ref.empty()) ||
           (ref.is_string() && ref.as_string_view().size() == 0) ||
           (ref.is_bool() && !ref.as_bool()) || ref.is_null();
  }

  static bool is_true(reference ref) { return !is_false(ref); }
  ...
  public:
    ...
    virtual reference evaluate(
      reference val, dynamic_resources<Json, JsonReference> &, std::error_code & ec) const = 0;
  };

  class not_expression final : public unary_operator
  {
  public:
    not_expression() : unary_operator(operator_kind::not_op) {}

    reference evaluate(
      reference val, dynamic_resources<Json, JsonReference> & resources,
  ...
  public:
    ...
    virtual reference evaluate(
      reference lhs, reference rhs, dynamic_resources<Json, JsonReference> &,
  ...
  public:
    ...
    bool is_projection() const { return is_projection_; }
  ...
  public:
    parameter(const parameter & other) noexcept : type_(other.type_)
    {
      switch (type_) {
    ...
    bool is_value() const { return type_ == parameter_kind::value; }

    bool is_expression() const { return type_ == parameter_kind::expression; }

    const Json & value() const { return *value_; }

    const expression_base & expression() const { return *expression_; }
  };
  ...
  public:
    ...
    virtual reference evaluate(
      std::vector<parameter> & args, dynamic_resources<Json, JsonReference> &,
      std::error_code & ec) const = 0;
  ...
  {
  public:
    abs_function() : function_base(1) {}

    reference evaluate(
      std::vector<parameter> & args, dynamic_resources<Json, JsonReference> & resources,
      ...
      switch (arg0.type()) {
        ...
        case json_type::int64_value: {
          return arg0.template as<int64_t>() >= 0
                   ? arg0
                   : *resources.create_json(std::abs(arg0.template as<int64_t>()));
        }
        case json_type::double_value: {
          return arg0.template as<double>() >= 0
                   ? arg0
                   : *resources.create_json(std::abs(arg0.template as<double>()));
        }
        default: {
          ec = jmespath_errc::invalid_type;
          return resources.null_value();
  ...
  {
  public:
    contains_function() : function_base(2) {}
      ...
      std::error_code & ec) const override
    {
      ...
      switch (arg0.type()) {
        ...
        case json_type::string_value: {
          ...
          return sv0.find(sv1) != string_view_type::npos ? resources.true_value()
                                                         : resources.false_value();
        }
        default: {
          ec = jmespath_errc::invalid_type;
          return resources.null_value();
  ...
  {
  public:
    ends_with_function() : function_base(2) {}
  ...
  {
  public:
    floor_function() : function_base(1) {}
  ...
  {
  public:
    length_function() : function_base(1) {}
  ...
  {
  public:
    max_by_function() : function_base(2) {}
  ...
  public:
    ...
    std::string to_string(std::size_t = 0) const override { return std::string("map_function\n"); }
  };

  class min_function : public function_base
  {
  public:
    min_function() : function_base(1) {}
  ...
  {
  public:
    min_by_function() : function_base(2) {}
  ...
  {
  public:
    merge_function() : function_base(jsoncons::optional<std::size_t>()) {}
  ...
  {
  public:
    sort_by_function() : function_base(2) {}
      ...
      std::error_code & ec) const override
    {
      ...
      auto v = resources.create_json(arg0);
      std::stable_sort(
        (v->array_range()).begin(), (v->array_range()).end(),
  ...
  {
  public:
    values_function() : function_base(1) {}
  ...
  {
  public:
    reverse_function() : function_base(1) {}
  ...
  {
  public:
    starts_with_function() : function_base(2) {}
  ...
  {
  public:
    to_array_function() : function_base(1) {}
  ...
  {
  public:
    to_number_function() : function_base(1) {}
  ...
  {
  public:
    to_string_function() : function_base(1) {}
  ...
  {
  public:
    not_null_function() : function_base(jsoncons::optional<std::size_t>()) {}
  ...
  public:
    token(current_node_arg_t) noexcept : type_(token_kind::current_node) {}

    token(end_function_arg_t) noexcept : type_(token_kind::end_function) {}

    token(separator_arg_t) noexcept : type_(token_kind::separator) {}

    token(lparen_arg_t) noexcept : type_(token_kind::lparen) {}

    token(rparen_arg_t) noexcept : type_(token_kind::rparen) {}

    token(end_of_expression_arg_t) noexcept : type_(token_kind::end_of_expression) {}

    token(begin_multi_select_hash_arg_t) noexcept : type_(token_kind::begin_multi_select_hash) {}

    token(end_multi_select_hash_arg_t) noexcept : type_(token_kind::end_multi_select_hash) {}

    token(begin_multi_select_list_arg_t) noexcept : type_(token_kind::begin_multi_select_list) {}

    token(end_multi_select_list_arg_t) noexcept : type_(token_kind::end_multi_select_list) {}

    token(begin_filter_arg_t) noexcept : type_(token_kind::begin_filter) {}

    token(end_filter_arg_t) noexcept : type_(token_kind::end_filter) {}

    token(pipe_arg_t) noexcept : type_(token_kind::pipe) {}

    token(key_arg_t, const string_type & key) : type_(token_kind::key)
    {
      new (&key_) string_type(key);
    }

    token(std::unique_ptr<expression_base> && expression) : type_(token_kind::expression)
    {
      new (&expression_) std::unique_ptr<expression_base>(std::move(expression));
    }

    token(const unary_operator * expression) noexcept
    : type_(token_kind::unary_operator), unary_operator_(expression)
    {
    }

    token(const binary_operator * expression) noexcept
    : type_(token_kind::binary_operator), binary_operator_(expression)
    {
    }

    token(const function_base * function) noexcept
    : type_(token_kind::function), function_(function)
    {
    }

    token(argument_arg_t) noexcept : type_(token_kind::argument) {}

    token(begin_expression_type_arg_t) noexcept : type_(token_kind::begin_expression_type) {}

    token(end_expression_type_arg_t) noexcept : type_(token_kind::end_expression_type) {}
    ...
    token_kind type() const { return type_; }

    bool is_lparen() const { return type_ == token_kind::lparen; }

    bool is_lbrace() const { return type_ == token_kind::begin_multi_select_hash; }

    bool is_key() const { return type_ == token_kind::key; }

    bool is_rparen() const { return type_ == token_kind::rparen; }

    bool is_current_node() const { return type_ == token_kind::current_node; }
    ...
    bool is_expression() const { return type_ == token_kind::expression; }

    bool is_operator() const
    {
      return type_ == token_kind::unary_operator || type_ == token_kind::binary_operator;
    }
  ...
  static pointer evaluate_tokens(
    reference doc, const std::vector<token> & output_stack,
    dynamic_resources<Json, JsonReference> & resources, std::error_code & ec)
  {
  ...
  {
  public:
    or_operator() : binary_operator(operator_kind::or_op) {}

    reference evaluate(
      reference lhs, reference rhs, dynamic_resources<Json, JsonReference> & resources,
      std::error_code &) const override
    {
  ...
  {
  public:
    and_operator() : binary_operator(operator_kind::and_op) {}
  ...
  {
  public:
    eq_operator() : binary_operator(operator_kind::eq_op) {}
  ...
  {
  public:
    ne_operator() : binary_operator(operator_kind::ne_op) {}
  ...
  {
  public:
    lt_operator() : binary_operator(operator_kind::lt_op) {}
  ...
  {
  public:
    lte_operator() : binary_operator(operator_kind::lte_op) {}
  ...
  {
  public:
    gt_operator() : binary_operator(operator_kind::gt_op) {}
  ...
  {
  public:
    gte_operator() : binary_operator(operator_kind::gte_op) {}
  ...
  {
  public:
    basic_expression() : expression_base(operator_kind::default_op, false) {}
  ...
  public:
    identifier_selector(const string_view_type & name) : identifier_(name) {}
  ...
  public:
    ...
    reference evaluate(
      reference val, dynamic_resources<Json, JsonReference> &, std::error_code &) const override
    {
      return val;
    }
  ...
  public:
    index_selector(int64_t index) : index_(index) {}
  ...
  public:
    projection_base(operator_kind oper) : expression_base(oper, true) {}

    void add_expression(std::unique_ptr<expression_base> && expr) override
    {
      if (
        !expressions_.empty() && expressions_.back()->is_projection() &&
        (expr->precedence_level() < expressions_.back()->precedence_level() ||
         (expr->precedence_level() == expressions_.back()->precedence_level() &&
          expr->is_right_associative()))) {
    ...
    reference apply_expressions(
      reference val, dynamic_resources<Json, JsonReference> & resources, std::error_code & ec) const
    {
  ...
  {
  public:
    object_projection() : projection_base(operator_kind::projection_op) {}
  ...
  {
  public:
    list_projection() : projection_base(operator_kind::projection_op) {}
  ...
  public:
    slice_projection(const slice & s) : projection_base(operator_kind::projection_op), slice_(s) {}
  ...
  {
  public:
    flatten_projection() : projection_base(operator_kind::flatten_projection_op) {}
  ...
  public:
    ...
    multi_select_hash(std::vector<key_tokens> && key_toks) : key_toks_(std::move(key_toks)) {}
      ...
      std::error_code & ec) const override
    {
      ...
      for (auto & item : key_toks_) {
        resultp->try_emplace(
          item.key, json_const_pointer_arg, evaluate_tokens(val, item.tokens, resources, ec));
      }
  ...
  public:
    ...
    function_expression(std::vector<token> && toks) : toks_(std::move(toks)) {}
  ...
  public:
    ...
    : resources_(std::move(expr.resources_)), output_stack_(std::move(expr.output_stack_))
    {
    }

    jmespath_expression(static_resources && resources, std::vector<token> && output_stack)
    ...
    static jmespath_expression compile(const string_view_type & expr, std::error_code & ec)
    {
      jsoncons::jmespath::detail::jmespath_evaluator<Json, const Json &> evaluator;
...
public:
  jmespath_evaluator()
  : line_(1), column_(1), begin_input_(nullptr), end_input_(nullptr), p_(nullptr)
  {
  }
  ...
  jmespath_expression compile(const char_type * path, std::size_t length, std::error_code & ec)
  {
  ...
  void push_token(token && tok, std::error_code & ec)
  {
    switch (tok.type()) {
      case token_kind::end_filter: {
        ...
        if (
          !output_stack_.empty() && output_stack_.back().is_projection() &&
          (tok.precedence_level() < output_stack_.back().precedence_level() ||
           (tok.precedence_level() == output_stack_.back().precedence_level() &&
            tok.is_right_associative()))) {
          output_stack_.back().expression_->add_expression(
            jsoncons::make_unique<filter_expression>(std::move(toks)));
        } else {
          output_stack_.emplace_back(
            token(jsoncons::make_unique<filter_expression>(std::move(toks))));
        }
        break;
      }
      case token_kind::end_multi_select_list: {
        ...
        while (it != output_stack_.rend() && it->type() != token_kind::begin_multi_select_list) {
          ...
          do {
            toks.emplace_back(std::move(*it));
            ++it;
          } while (it != output_stack_.rend() &&
                   it->type() != token_kind::begin_multi_select_list &&
                   it->type() != token_kind::separator);
        ...
        if (
          ...
          (tok.precedence_level() < output_stack_.back().precedence_level() ||
           (tok.precedence_level() == output_stack_.back().precedence_level() &&
            tok.is_right_associative()))) {
          output_stack_.back().expression_->add_expression(
            jsoncons::make_unique<multi_select_list>(std::move(vals)));
        } else {
          output_stack_.emplace_back(
            token(jsoncons::make_unique<multi_select_list>(std::move(vals))));
        }
        break;
      }
        ...
        if (
          ...
          (tok.precedence_level() < output_stack_.back().precedence_level() ||
           (tok.precedence_level() == output_stack_.back().precedence_level() &&
            tok.is_right_associative()))) {
          output_stack_.back().expression_->add_expression(
            jsoncons::make_unique<multi_select_hash>(std::move(key_toks)));
        } else {
          output_stack_.emplace_back(
            token(jsoncons::make_unique<multi_select_hash>(std::move(key_toks))));
        }
        break;
      }
      case token_kind::end_expression_type: {
        ...
        output_stack_.erase(it.base(), output_stack_.end());
        output_stack_.emplace_back(
          token(jsoncons::make_unique<function_expression>(std::move(toks))));
        break;
      }
      case token_kind::literal:
        ...
        if (
          ...
          (tok.precedence_level() < output_stack_.back().precedence_level() ||
           (tok.precedence_level() == output_stack_.back().precedence_level() &&
            tok.is_right_associative()))) {
          output_stack_.back().expression_->add_expression(
            jsoncons::make_unique<function_expression>(std::move(toks)));
        } else {
          output_stack_.emplace_back(
            token(jsoncons::make_unique<function_expression>(std::move(toks))));
        }
      ...
      case token_kind::binary_operator: {
        if (operator_stack_.empty() || operator_stack_.back().is_lparen()) {
          ...
          tok.precedence_level() < operator_stack_.back().precedence_level() ||
          (tok.precedence_level() == operator_stack_.back().precedence_level() &&
           tok.is_right_associative())) {
          operator_stack_.emplace_back(std::move(tok));
        } else {
          auto it = operator_stack_.rbegin();
          while (
            it != operator_stack_.rend() && it->is_operator() &&
...
template <class Json>
using jmespath_expression =
  typename jsoncons::jmespath::detail::jmespath_evaluator<Json, const Json &>::jmespath_expression;
...
template <class Json>
jmespath_expression<Json> make_expression(
