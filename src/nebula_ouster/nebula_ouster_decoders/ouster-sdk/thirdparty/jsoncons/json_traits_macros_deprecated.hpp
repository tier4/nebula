...
#define JSONCONS_MEMBER_TRAITS_DECL(ValueType, ...)                                           \
  JSONCONS_MEMBER_TRAITS_BASE(                                                                \
    JSONCONS_AS, JSONCONS_TO_JSON, 0, ValueType, JSONCONS_NARGS(__VA_ARGS__), 0, __VA_ARGS__) \
  /**/

#define JSONCONS_TPL_MEMBER_TRAITS_DECL(NumTemplateParams, ValueType, ...)                       \
  JSONCONS_MEMBER_TRAITS_BASE(                                                                   \
    JSONCONS_AS, JSONCONS_TO_JSON, NumTemplateParams, ValueType, JSONCONS_NARGS(__VA_ARGS__), 0, \
    __VA_ARGS__)                                                                                 \
  /**/

#define JSONCONS_MEMBER_NAMED_TRAITS_DECL(ValueType, ...)                                  \
  JSONCONS_MEMBER_NAME_TRAITS_BASE(                                                        \
    JSONCONS_NAME_AS, JSONCONS_NAME_TO_JSON, 0, ValueType, JSONCONS_NARGS(__VA_ARGS__), 0, \
    __VA_ARGS__)                                                                           \
  /**/
...
#define JSONCONS_TPL_GETTER_SETTER_TRAITS_DECL(                                              \
...
#define JSONCONS_GETTER_SETTER_NAMED_TRAITS_DECL(ValueType, ...)                       \
  JSONCONS_GETTER_SETTER_NAME_TRAITS_BASE(                                             \
    JSONCONS_GETTER_SETTER_NAME_AS, JSONCONS_GETTER_SETTER_NAME_TO_JSON, 0, ValueType, \
    JSONCONS_NARGS(__VA_ARGS__), 0, __VA_ARGS__)                                       \
  /**/
