...
public:
  ...
  basic_item_event(
    item_event_kind event_kind, std::size_t length, semantic_tag tag = semantic_tag::none)
  ...
  basic_item_event(
    const string_view_type & s, item_event_kind event_kind, semantic_tag tag = semantic_tag::none)
  ...
  basic_item_event(
    const byte_string_view & s, item_event_kind event_kind, semantic_tag tag = semantic_tag::none)
  : event_kind_(event_kind), tag_(tag), ext_tag_(0), length_(s.size())
  {
    value_.byte_string_data_ = s.data();
  }

  basic_item_event(const byte_string_view & s, item_event_kind event_kind, uint64_t ext_tag)
  ...
  typename std::enable_if<
    extension_traits::is_string<T>::value && std::is_same<typename T::value_type, CharT_>::value,
    T>::type
    ...
    switch (event_kind_) {
      case item_event_kind::string_value: {
        ...
        return converter.convert(
          jsoncons::basic_string_view<CharT>(value_.string_data_, length_), tag(), ec);
      }
      case item_event_kind::byte_string_value: {
  ...
  template <class T>
  typename std::enable_if<std::is_same<T, byte_string_view>::value, T>::type get(
  ...
  typename std::enable_if<extension_traits::is_integer<IntegerType>::value, IntegerType>::type get(
    std::error_code & ec) const
  {
    switch (event_kind_) {
      case item_event_kind::string_value: {
  ...
  template <class T>
  typename std::enable_if<std::is_floating_point<T>::value, T>::type get(std::error_code & ec) const
  {
...
public:
  friend bool send_value_event(
    const basic_item_event<CharT> & ev, basic_item_event_visitor<CharT> & visitor,
    ...
    switch (ev.event_kind()) {
      ...
      case item_event_kind::string_value:
        return visitor.string_value(
          string_view_type(ev.value_.string_data_, ev.length_), ev.tag(), context);
      case item_event_kind::byte_string_value:
        return visitor.byte_string_value(
          byte_string_view(ev.value_.byte_string_data_, ev.length_), ev.tag(), context);
      case item_event_kind::null_value:
...
public:
  basic_item_event_receiver()
  : pred_(accept), event_(item_event_kind::null_value), state_(), data_(), shape_(), index_(0)
  {
  }

  basic_item_event_receiver(
    std::function<bool(const basic_item_event<CharT> &, const ser_context &)> pred)
  : pred_(pred), event_(item_event_kind::null_value), state_(), data_(), shape_(), index_(0)
  {
  }
      ...
      if (index_ < data_.size()) {
        switch (data_.type()) {
          case typed_array_type::uint8_value: {
            this->uint64_value(
              data_.data(uint8_array_arg)[index_], semantic_tag::none, ser_context(), ec);
            break;
          }
          case typed_array_type::uint16_value: {
            this->uint64_value(
              data_.data(uint16_array_arg)[index_], semantic_tag::none, ser_context(), ec);
            break;
          }
          case typed_array_type::uint32_value: {
            this->uint64_value(
              data_.data(uint32_array_arg)[index_], semantic_tag::none, ser_context(), ec);
            break;
          }
          case typed_array_type::uint64_value: {
            this->uint64_value(
              data_.data(uint64_array_arg)[index_], semantic_tag::none, ser_context(), ec);
            break;
          }
          case typed_array_type::int8_value: {
            this->int64_value(
              data_.data(int8_array_arg)[index_], semantic_tag::none, ser_context(), ec);
            break;
          }
          case typed_array_type::int16_value: {
            this->int64_value(
              data_.data(int16_array_arg)[index_], semantic_tag::none, ser_context(), ec);
            break;
          }
          case typed_array_type::int32_value: {
            this->int64_value(
              data_.data(int32_array_arg)[index_], semantic_tag::none, ser_context(), ec);
            break;
          }
          case typed_array_type::int64_value: {
            this->int64_value(
              data_.data(int64_array_arg)[index_], semantic_tag::none, ser_context(), ec);
            break;
          }
          case typed_array_type::half_value: {
            this->half_value(
              data_.data(half_array_arg)[index_], semantic_tag::none, ser_context(), ec);
            break;
          }
          case typed_array_type::float_value: {
            this->double_value(
              data_.data(float_array_arg)[index_], semantic_tag::none, ser_context(), ec);
            break;
          }
          case typed_array_type::double_value: {
            this->double_value(
              data_.data(double_array_arg)[index_], semantic_tag::none, ser_context(), ec);
            break;
          }
          default:
            break;
  ...
  bool dump(
    basic_item_event_visitor<CharT> & visitor, const ser_context & context, std::error_code & ec)
  {
    bool more = true;
    if (is_typed_array()) {
      if (index_ != 0) {
...
private:
  ...
  bool visit_begin_object(
    std::size_t length, semantic_tag tag, const ser_context & context, std::error_code &) override
  {
  ...
  bool visit_bool(
    bool value, semantic_tag tag, const ser_context & context, std::error_code &) override
  {
  ...
  bool visit_string(
    const string_view_type & s, semantic_tag tag, const ser_context & context,
  ...
  bool visit_byte_string(
    const byte_string_view & s, semantic_tag tag, const ser_context & context,
    std::error_code &) override
  {
  ...
  bool visit_byte_string(
    const byte_string_view & s, uint64_t ext_tag, const ser_context & context,
    std::error_code &) override
  {
  ...
  bool visit_uint64(
    uint64_t value, semantic_tag tag, const ser_context & context, std::error_code &) override
  {
    event_ = basic_item_event<CharT>(value, tag);
    return !pred_(event_, context);
  }
  ...
  bool visit_int64(
    int64_t value, semantic_tag tag, const ser_context & context, std::error_code &) override
  {
    event_ = basic_item_event<CharT>(value, tag);
    return !pred_(event_, context);
  }
  ...
  bool visit_half(
    uint16_t value, semantic_tag tag, const ser_context & context, std::error_code &) override
  {
  ...
  bool visit_double(
    double value, semantic_tag tag, const ser_context & context, std::error_code &) override
  {
    event_ = basic_item_event<CharT>(value, tag);
    return !pred_(event_, context);
  }
  ...
  bool visit_typed_array(
    const jsoncons::span<const uint8_t> & v, semantic_tag tag, const ser_context & context,
  ...
  bool visit_typed_array(
    const jsoncons::span<const uint16_t> & data, semantic_tag tag, const ser_context & context,
    std::error_code & ec) override
  {
    state_ = item_event_reader_state::typed_array;
  ...
  bool visit_typed_array(
    const jsoncons::span<const uint32_t> & data, semantic_tag tag, const ser_context & context,
    std::error_code & ec) override
  {
    state_ = item_event_reader_state::typed_array;
    data_ = typed_array_view(data.data(), data.size());
  ...
  bool visit_typed_array(
    const jsoncons::span<const uint64_t> & data, semantic_tag tag, const ser_context & context,
    std::error_code & ec) override
  {
    state_ = item_event_reader_state::typed_array;
    data_ = typed_array_view(data.data(), data.size());
  ...
  bool visit_typed_array(
    const jsoncons::span<const int8_t> & data, semantic_tag tag, const ser_context & context,
    std::error_code & ec) override
  {
    state_ = item_event_reader_state::typed_array;
    data_ = typed_array_view(data.data(), data.size());
  ...
  bool visit_typed_array(
    const jsoncons::span<const int16_t> & data, semantic_tag tag, const ser_context & context,
    std::error_code & ec) override
  {
    state_ = item_event_reader_state::typed_array;
    data_ = typed_array_view(data.data(), data.size());
  ...
  bool visit_typed_array(
    const jsoncons::span<const int32_t> & data, semantic_tag tag, const ser_context & context,
    std::error_code & ec) override
  {
    state_ = item_event_reader_state::typed_array;
    data_ = typed_array_view(data.data(), data.size());
  ...
  bool visit_typed_array(
    const jsoncons::span<const int64_t> & data, semantic_tag tag, const ser_context & context,
    std::error_code & ec) override
  {
    state_ = item_event_reader_state::typed_array;
    data_ = typed_array_view(data.data(), data.size());
  ...
  bool visit_typed_array(
    half_arg_t, const jsoncons::span<const uint16_t> & data, semantic_tag tag,
  ...
  bool visit_typed_array(
    const jsoncons::span<const float> & data, semantic_tag tag, const ser_context & context,
    std::error_code & ec) override
  {
    state_ = item_event_reader_state::typed_array;
    data_ = typed_array_view(data.data(), data.size());
  ...
  bool visit_typed_array(
    const jsoncons::span<const double> & data, semantic_tag tag, const ser_context & context,
    std::error_code & ec) override
  {
    state_ = item_event_reader_state::typed_array;
    data_ = typed_array_view(data.data(), data.size());
...
public:
  ...
  {
    if (!(current().event_kind() == item_event_kind::begin_array ||
          current().event_kind() == item_event_kind::byte_string_value)) {
  ...
  virtual void read_to(basic_item_event_visitor<CharT> & visitor, std::error_code & ec) = 0;
...
public:
  basic_staj2_filter_view(
    basic_item_event_reader<CharT> & cursor,
    std::function<bool(const basic_item_event<CharT> &, const ser_context &)> pred)
  ...
  const basic_item_event<CharT> & current() const override { return cursor_->current(); }

  void read_to(basic_item_event_visitor<CharT> & visitor) override { cursor_->read_to(visitor); }

  void read_to(basic_item_event_visitor<CharT> & visitor, std::error_code & ec) override
  {
