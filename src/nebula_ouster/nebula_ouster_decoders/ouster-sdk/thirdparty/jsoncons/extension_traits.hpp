...
struct is_char8<
  CharT, typename std::enable_if<
           std::is_integral<CharT>::value && !std::is_same<CharT, bool>::value &&
...
struct is_char16<
  CharT, typename std::enable_if<
           std::is_integral<CharT>::value && !std::is_same<CharT, bool>::value &&
           (std::is_same<CharT, char16_t>::value || sizeof(uint16_t) == sizeof(CharT))>::type>
: std::true_type
{
};
...
struct is_char32<
  CharT, typename std::enable_if<
           ...
           (std::is_same<CharT, char32_t>::value ||
            (!std::is_same<CharT, char16_t>::value && sizeof(uint32_t) == sizeof(CharT)))>::type>
: std::true_type
{
};
...
template <class T>
struct is_int128_type<T, typename std::enable_if<std::is_same<T, int128_type>::value>::type>
: std::true_type
{
};
#endif
...
#if defined(JSONCONS_HAS_INT128)
template <class T>
struct is_uint128_type<T, typename std::enable_if<std::is_same<T, uint128_type>::value>::type>
: std::true_type
{
};
#endif
...
template <class T>
class integer_limits<
  T, typename std::enable_if<!std::is_integral<T>::value && is_int128_type<T>::value>::type>
{
public:
  static constexpr bool is_specialized = true;
...
template <class T>
class integer_limits<
  T, typename std::enable_if<!std::is_integral<T>::value && is_uint128_type<T>::value>::type>
{
public:
  static constexpr bool is_specialized = true;
...
using is_detected_convertible = std::is_convertible<is_detected_t<Op, Args...>, To>;

template <typename T>
struct is_stateless : public std::integral_constant<
                        bool, (std::is_default_constructible<T>::value && std::is_empty<T>::value)>
{
};
...
template <class T>
struct is_std_byte<T, typename std::enable_if<std::is_same<T, std::byte>::value>::type>
: std::true_type
{
};
#endif
...
struct is_byte<
  T, typename std::enable_if<
       ...
       std::is_same<T, unsigned char>::value || is_std_byte<T>::value>::type> : std::true_type
{
};
...
#endif
       std::is_same<T, wchar_t>::value>::type> : std::true_type
{
};
...
struct is_narrow_character<
  T, typename std::enable_if<is_character<T>::value && (sizeof(T) == sizeof(char))>::type>
: std::true_type
{
};
...
template <class T>
struct is_bool<T, typename std::enable_if<std::is_same<T, bool>::value>::type> : std::true_type
{
};
...
struct is_u8_u16_u32_or_u64<
  T, typename std::enable_if<
       ...
       std::is_same<T, uint32_t>::value || std::is_same<T, uint64_t>::value>::type> : std::true_type
{
};
...
struct is_i8_i16_i32_or_i64<
  T, typename std::enable_if<
       ...
       std::is_same<T, int32_t>::value || std::is_same<T, int64_t>::value>::type> : std::true_type
{
};
...
struct is_float_or_double<
  T, typename std::enable_if<std::is_same<T, float>::value || std::is_same<T, double>::value>::type>
: std::true_type
{
};
...
template <class T>
struct is_integer<T, typename std::enable_if<integer_limits<T>::is_specialized>::type>
: std::true_type
{
};
...
struct is_signed_integer<
  T,
  typename std::enable_if<integer_limits<T>::is_specialized && integer_limits<T>::is_signed>::type>
: std::true_type
{
};
...
struct is_primitive<
  T, typename std::enable_if<
       is_integer<T>::value || is_bool<T>::value || std::is_floating_point<T>::value>::type>
: std::true_type
{
};
...
template <class Container>
using container_push_back_t =
  decltype(std::declval<Container>().push_back(std::declval<typename Container::value_type>()));

template <class Container>
using container_push_front_t =
  decltype(std::declval<Container>().push_front(std::declval<typename Container::value_type>()));

template <class Container>
using container_insert_t =
  decltype(std::declval<Container>().insert(std::declval<typename Container::value_type>()));

template <class Container>
using container_reserve_t =
  decltype(std::declval<Container>().reserve(typename Container::size_type()));
...
struct has_allocator_type<
  T, typename std::enable_if<is_detected<container_allocator_type_t, T>::value>::type>
: std::true_type
{
};
...
struct is_string<
  T,
  typename std::enable_if<is_string_or_string_view<T>::value && has_allocator_type<T>::value>::type>
: std::true_type
{
};
...
struct is_string_view<
  ...
  typename std::enable_if<
    is_string_or_string_view<T>::value && !is_detected<container_allocator_type_t, T>::value>::type>
: std::true_type
{
};
...
struct is_map_like<
  T, typename std::enable_if<
       ...
       is_detected<container_value_type_t, T>::value>::type> : std::true_type
{
};
...
struct is_list_like<
  T, typename std::enable_if<
       ...
       is_detected<container_allocator_type_t, T>::value && !is_std_array<T>::value &&
       !is_detected_exact<typename T::value_type, container_char_traits_t, T>::value &&
...
struct is_constructible_from_const_pointer_and_size<
  T, typename std::enable_if<
       std::is_constructible<T, typename T::const_pointer, typename T::size_type>::value>::type>
: std::true_type
{
};
...
struct is_byte_sequence<
  Container, typename std::enable_if<
               has_data_exact<const typename Container::value_type *, const Container>::value &&
               has_size<Container>::value && is_byte<typename Container::value_type>::value>::type>
: std::true_type
{
};
...
struct is_char_sequence<
  ...
  typename std::enable_if<
    has_data_exact<const typename Container::value_type *, const Container>::value &&
    has_size<Container>::value && is_character<typename Container::value_type>::value>::type>
: std::true_type
{
};
...
struct is_sequence_of<
  ...
  typename std::enable_if<
    ...
    std::is_same<typename Container::value_type, ValueT>::value>::type> : std::true_type
{
};
...
struct is_back_insertable_byte_container<
  Container,
  typename std::enable_if<
    is_back_insertable<Container>::value && is_byte<typename Container::value_type>::value>::type>
: std::true_type
{
};
...
struct is_back_insertable_char_container<
  Container, typename std::enable_if<
               ...
               is_character<typename Container::value_type>::value>::type> : std::true_type
{
};
...
struct is_compatible_element<
  Container, Element, typename std::enable_if<has_data<Container>::value>::type>
: std::is_convertible<
...
using construct_from_data_size_t = decltype(T(static_cast<Data>(nullptr), Size{}));

template <class T, typename Data, typename Size>
using is_constructible_from_data_size = is_detected<construct_from_data_size_t, T, Data, Size>;

// is_unary_function_object
// is_unary_function_object_exact

template <class FunctionObject, class Arg>
using unary_function_object_t = decltype(std::declval<FunctionObject>()(std::declval<Arg>()));

template <class FunctionObject, class Arg>
using is_unary_function_object = is_detected<unary_function_object_t, FunctionObject, Arg>;
...
using binary_function_object_t =
  decltype(std::declval<FunctionObject>()(std::declval<Arg1>(), std::declval<Arg2>()));

template <class FunctionObject, class Arg1, class Arg2>
using is_binary_function_object = is_detected<binary_function_object_t, FunctionObject, Arg1, Arg2>;
...
struct is_convertible_to_string_view<
  Source, typename std::enable_if<
            is_string_or_string_view<Source>::value || is_cstring<Source>::value>::type>
: std::true_type
{
};
...
using allocator_outer_allocator_type_t = typename Allocator::outer_allocator_type;

template <class Allocator>
using allocator_inner_allocator_type_t = typename Allocator::inner_allocator_type;
...
struct is_polymorphic_allocator<
  T, typename std::enable_if<(std::is_same<T, std::pmr::polymorphic_allocator<char>>::value)>::type>
: std::true_type
{
};
#endif
...
struct is_propagating_allocator<
  T, typename std::enable_if<
       ...
       (is_detected<allocator_outer_allocator_type_t, T>::value &&
        is_detected<allocator_inner_allocator_type_t, T>::value)>::type> : std::true_type
{
};
