...
template <
  class CharT, class Source = jsoncons::stream_source<CharT>,
...
private:
  using char_allocator_type =
    typename std::allocator_traits<TempAllocator>::template rebind_alloc<CharT>;
...
public:
  ...
  explicit basic_json_reader(
    Sourceable && source, const TempAllocator & temp_alloc = TempAllocator())
  : basic_json_reader(
      std::forward<Sourceable>(source), default_visitor_, basic_json_decode_options<CharT>(),
  ...
  : basic_json_reader(
      std::forward<Sourceable>(source), default_visitor_, options, options.err_handler(),
      temp_alloc)
  {
  }
  ...
  template <class Sourceable>
  basic_json_reader(
    Sourceable && source, std::function<bool(json_errc, const ser_context &)> err_handler,
    const TempAllocator & temp_alloc = TempAllocator())
  : basic_json_reader(
      std::forward<Sourceable>(source), default_visitor_, basic_json_decode_options<CharT>(),
  ...
  basic_json_reader(
    ...
    const TempAllocator & temp_alloc = TempAllocator())
  : basic_json_reader(
      std::forward<Sourceable>(source), default_visitor_, options, err_handler, temp_alloc)
  {
  }
  ...
  basic_json_reader(
    ...
    const TempAllocator & temp_alloc = TempAllocator())
  : basic_json_reader(
      std::forward<Sourceable>(source), visitor, basic_json_decode_options<CharT>(),
      default_json_parsing(), temp_alloc)
  {
  }
  ...
  basic_json_reader(
    ...
    const TempAllocator & temp_alloc = TempAllocator())
  : basic_json_reader(
      std::forward<Sourceable>(source), visitor, options, options.err_handler(), temp_alloc)
  {
  }
  ...
  basic_json_reader(
    ...
    const TempAllocator & temp_alloc = TempAllocator())
  : basic_json_reader(
      std::forward<Sourceable>(source), visitor, basic_json_decode_options<CharT>(), err_handler,
      temp_alloc)
  {
  }
...
public:
  ...
  legacy_basic_json_reader(
    ...
    const TempAllocator & temp_alloc = TempAllocator())
  : legacy_basic_json_reader(
      std::forward<Sourceable>(source), default_visitor_, options, default_json_parsing(),
      temp_alloc)
  {
  }
  ...
  legacy_basic_json_reader(
    ...
    const TempAllocator & temp_alloc = TempAllocator())
  : legacy_basic_json_reader(
      std::forward<Sourceable>(source), visitor, options, default_json_parsing(), temp_alloc)
  {
  }
  ...
  legacy_basic_json_reader(
    ...
    typename std::enable_if<
      !std::is_constructible<jsoncons::basic_string_view<CharT>, Sourceable>::value>::type * = 0)
  : source_(std::forward<Sourceable>(source)),
    visitor_(visitor),
    parser_(options, err_handler, temp_alloc)
  {
  ...
  legacy_basic_json_reader(
    ...
    typename std::enable_if<
      std::is_constructible<jsoncons::basic_string_view<CharT>, Sourceable>::value>::type * = 0)
  : source_(), visitor_(visitor), parser_(options, err_handler, temp_alloc)
  {
    ...
    if (!(r.encoding == unicode_traits::encoding_kind::utf8 ||
      ...
      JSONCONS_THROW(
        ser_error(json_errc::illegal_unicode_character, parser_.line(), parser_.column()));
    }
