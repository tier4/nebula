...
using container_array_iterator_type_t = decltype(Container::array_iterator_type);
template <class Container>
using container_const_array_iterator_type_t = decltype(Container::const_array_iterator_type);
template <class Container>
using container_object_iterator_type_t = decltype(Container::object_iterator_type);
template <class Container>
using container_const_object_iterator_type_t = decltype(Container::const_object_iterator_type);
...
template <class T>
using basic_json_t =
  basic_json<typename T::char_type, typename T::policy_type, typename T::allocator_type>;
...
struct is_basic_json<
  T, typename std::enable_if<extension_traits::is_detected<
       detail::basic_json_t, typename std::decay<T>::type>::value>::type> : std::true_type
{
};
...
public:
  ...
  bool operator>(const random_access_iterator_wrapper & rhs) const noexcept { return rhs < *this; }
...
struct object_iterator_typedefs<
  ...
  typename std::enable_if<
    !extension_traits::is_detected<
      extension_traits::container_object_iterator_type_t, Policy>::value ||
    !extension_traits::is_detected<
      extension_traits::container_const_object_iterator_type_t, Policy>::value>::type>
{
  ...
  using const_object_iterator_type = jsoncons::detail::random_access_iterator_wrapper<
...
struct array_iterator_typedefs<
  ...
  typename std::enable_if<
    ...
    !extension_traits::is_detected<
      extension_traits::container_const_array_iterator_type_t, Policy>::value>::type>
{
...
public:
  range(const IteratorT & first, const IteratorT & last) : first_(first), last_(last) {}
  ...
  const_reverse_iterator crbegin() const noexcept { return reverse_iterator(last_); }
  const_reverse_iterator crend() const noexcept { return reverse_iterator(first_); }
};
...
public:
  ...
  using char_allocator_type =
    typename std::allocator_traits<allocator_type>::template rebind_alloc<char_type>;

  using string_type = std::basic_string<char_type, char_traits_type, char_allocator_type>;

  using key_type =
    typename policy_type::template member_key<char_type, char_traits_type, char_allocator_type>;
  ...
  using key_value_allocator_type =
    typename std::allocator_traits<allocator_type>::template rebind_alloc<key_value_type>;

  using object = typename policy_type::template object<key_type, basic_json>;

  using object_iterator =
    typename object_iterator_typedefs<policy_type, key_type, basic_json>::object_iterator_type;
  using const_object_iterator = typename object_iterator_typedefs<
    policy_type, key_type, basic_json>::const_object_iterator_type;
  using array_iterator =
    typename array_iterator_typedefs<policy_type, key_type, basic_json>::array_iterator_type;
  using const_array_iterator =
    typename array_iterator_typedefs<policy_type, key_type, basic_json>::const_array_iterator_type;
...
public:
  ...
  public:
    ...
    : storage_kind_(static_cast<uint8_t>(json_storage_kind::null_value)),
  ...
  public:
    ...
    : storage_kind_(static_cast<uint8_t>(json_storage_kind::empty_object_value)),
      small_string_length_(0),
      tag_(tag)
    {
    }
  ...
  public:
    ...
    : storage_kind_(static_cast<uint8_t>(json_storage_kind::bool_value)),
      small_string_length_(0),
      tag_(tag),
      val_(val)
    {
  ...
  public:
    ...
    : storage_kind_(static_cast<uint8_t>(json_storage_kind::int64_value)),
      small_string_length_(0),
      tag_(tag),
      val_(val)
    {
  ...
  public:
    ...
    : storage_kind_(static_cast<uint8_t>(json_storage_kind::uint64_value)),
      small_string_length_(0),
      tag_(tag),
      val_(val)
    {
  ...
  public:
    ...
    : storage_kind_(static_cast<uint8_t>(json_storage_kind::half_value)),
      small_string_length_(0),
      tag_(tag),
      val_(val)
    {
  ...
  public:
    ...
    : storage_kind_(static_cast<uint8_t>(json_storage_kind::double_value)),
      small_string_length_(0),
      tag_(tag),
      val_(val)
    {
  ...
  public:
    ...
    : storage_kind_(static_cast<uint8_t>(json_storage_kind::short_string_value)),
    ...
    uint8_t length() const { return small_string_length_; }
  ...
  public:
    long_string_storage(
      semantic_tag tag, const char_type * data, std::size_t length, const Allocator & alloc)
    : storage_kind_(static_cast<uint8_t>(json_storage_kind::long_string_value)),
      small_string_length_(0),
      tag_(tag)
    {
    ...
    void assign(const long_string_storage & other)
    {
      assign(
        std::integral_constant<
          bool, std::allocator_traits<Allocator>::propagate_on_container_copy_assignment::value>(),
        other);
    }
  ...
  public:
    byte_string_storage(
      semantic_tag tag, const uint8_t * data, std::size_t length, uint64_t ext_tag,
      const Allocator & alloc)
    : storage_kind_(static_cast<uint8_t>(json_storage_kind::byte_string_value)),
      small_string_length_(0),
      tag_(tag)
    {
    ...
    : storage_kind_(other.storage_kind_), small_string_length_(0), tag_(other.tag_)
    {
      if (other.get_allocator() == alloc) {
        ...
        ptr_ =
          heap_string_factory_type::create(other.data(), other.length(), other.ext_tag(), alloc);
      }
    }
    ...
    void create(array_allocator alloc, Args &&... args)
    {
      ...
      JSONCONS_TRY
      {
        std::allocator_traits<array_allocator>::construct(
          alloc, extension_traits::to_plain_pointer(ptr_), std::forward<Args>(args)...);
      }
      JSONCONS_CATCH(...)
      {
  ...
  public:
    ...
    : storage_kind_(static_cast<uint8_t>(json_storage_kind::array_value)),
      small_string_length_(0),
      tag_(tag)
    {
  ...
  private:
    using object_allocator =
      typename std::allocator_traits<Allocator>::template rebind_alloc<object>;
  ...
  public:
    ...
    : storage_kind_(static_cast<uint8_t>(json_storage_kind::object_value)),
      small_string_length_(0),
      tag_(tag),
      ptr_(nullptr)
    {
...
private:
  ...
  public:
    ...
    : storage_kind_(static_cast<uint8_t>(json_storage_kind::json_const_pointer)),
      small_string_length_(0),
      tag_(p->tag()),
      p_(p)
    {
  ...
  class proxy
  {
    ...
    proxy(ParentType & parent, const string_view_type & key) : parent_(parent), key_(key) {}
    ...
    const basic_json & evaluate(std::size_t index) const { return evaluate().at(index); }

    basic_json & evaluate(const string_view_type & index) { return evaluate().at(index); }
  ...
  public:
    ...
    const_object_range_type object_range() const { return evaluate().object_range(); }

    array_range_type array_range() { return evaluate().array_range(); }

    const_array_range_type array_range() const { return evaluate().array_range(); }
    ...
    std::size_t count(const string_view_type & name) const { return evaluate().count(name); }
    ...
    string_view_type as_string_view() const { return evaluate().as_string_view(); }

    byte_string_view as_byte_string_view() const { return evaluate().as_byte_string_view(); }
    ...
    template <class T>
    typename std::enable_if<is_json_type_traits_specialized<basic_json, T>::value, T>::type as()
      const
    {
    ...
    basic_json & operator[](std::size_t i) { return evaluate_with_default().at(i); }

    const basic_json & operator[](std::size_t i) const { return evaluate().at(i); }

    proxy_type operator[](const string_view_type & key) { return proxy_type(*this, key); }

    const basic_json & operator[](const string_view_type & name) const { return at(name); }

    basic_json & at(const string_view_type & name) { return evaluate().at(name); }

    const basic_json & at(const string_view_type & name) const { return evaluate().at(name); }
    ...
    const basic_json & at(std::size_t index) const { return evaluate().at(index); }

    object_iterator find(const string_view_type & name) { return evaluate().find(name); }
    ...
    {
      static_assert(
        std::is_copy_constructible<T>::value, "get_value_or: T must be copy constructible");
      static_assert(
        std::is_convertible<U &&, T>::value, "get_value_or: U must be convertible to T");
    ...
    object_iterator erase(const_object_iterator pos) { return evaluate().erase(pos); }
    ...
    array_iterator erase(const_array_iterator pos) { return evaluate().erase(pos); }
    ...
    void merge(basic_json && source) { return evaluate().merge(std::move(source)); }
    ...
    void merge_or_update(const basic_json & source) { return evaluate().merge_or_update(source); }
    ...
    template <class... Args>
    object_iterator try_emplace(
      object_iterator hint, const string_view_type & name, Args &&... args)
    {
    ...
    std::basic_string<char_type> to_string() const { return evaluate().to_string(); }
    ...
    semantic_tag get_semantic_tag() const { return evaluate().tag(); }
    ...
    JSONCONS_DEPRECATED_MSG(
      "Instead, use insert_or_assign(object_iterator, const string_view_type&, T&&)")
    ...
    bool has_key(const string_view_type & name) const noexcept { return contains(name); }
    ...
    int as_int() const { return evaluate().template as<int>(); }

    JSONCONS_DEPRECATED_MSG("Instead, use as<unsigned int>()")
    unsigned int as_uint() const { return evaluate().template as<unsigned int>(); }

    JSONCONS_DEPRECATED_MSG("Instead, use as<long>()")
    long as_long() const { return evaluate().template as<long>(); }

    JSONCONS_DEPRECATED_MSG("Instead, use as<unsigned long>()")
    unsigned long as_ulong() const { return evaluate().template as<unsigned long>(); }

    JSONCONS_DEPRECATED_MSG("Instead, use as<long long>()")
    long long as_longlong() const { return evaluate().template as<long long>(); }

    JSONCONS_DEPRECATED_MSG("Instead, use as<unsigned long long>()")
    unsigned long long as_ulonglong() const { return evaluate().template as<unsigned long long>(); }

    JSONCONS_DEPRECATED_MSG("Instead, use as<uint64_t>()")
    uint64_t as_uinteger() const { return evaluate().template as<uint64_t>(); }

    JSONCONS_DEPRECATED_MSG("Instead, use dump(basic_json_visitor<char_type>&)")
    void write(basic_json_visitor<char_type> & visitor) const { evaluate().dump(visitor); }

    JSONCONS_DEPRECATED_MSG("Instead, use dump(std::basic_ostream<char_type>&)")
    void write(std::basic_ostream<char_type> & os) const { evaluate().dump(os); }

    JSONCONS_DEPRECATED_MSG(
      "Instead, use dump(std::basic_ostream<char_type>&, const "
    ...
    JSONCONS_DEPRECATED_MSG(
      "Instead, use dump_pretty(std::basic_ostream<char_type>&, const "
      "basic_json_encode_options<char_type>&)")
    void write(
      std::basic_ostream<char_type> & os, const basic_json_encode_options<char_type> & options,
      bool pprint) const
    {
      if (pprint) {
    ...
    JSONCONS_DEPRECATED_MSG("Instead, use dump(basic_json_visitor<char_type>&)")
    void to_stream(basic_json_visitor<char_type> & visitor) const { evaluate().dump(visitor); }

    JSONCONS_DEPRECATED_MSG("Instead, use dump(std::basic_ostream<char_type>&)")
    void to_stream(std::basic_ostream<char_type> & os) const { evaluate().dump(os); }
    ...
    void resize_array(std::size_t n) { evaluate().resize(n); }
    ...
    object_range_type members() { return evaluate().object_range(); }

    JSONCONS_DEPRECATED_MSG("Instead, use object_range()")
    const_object_range_type members() const { return evaluate().object_range(); }

    JSONCONS_DEPRECATED_MSG("Instead, use array_range()")
    array_range_type elements() { return evaluate().array_range(); }

    JSONCONS_DEPRECATED_MSG("Instead, use array_range()")
    const_array_range_type elements() const { return evaluate().array_range(); }

    JSONCONS_DEPRECATED_MSG("Instead, use object_range().begin()")
    object_iterator begin_members() { return evaluate().object_range().begin(); }

    JSONCONS_DEPRECATED_MSG("Instead, use object_range().begin()")
    const_object_iterator begin_members() const { return evaluate().object_range().begin(); }

    JSONCONS_DEPRECATED_MSG("Instead, use object_range().end()")
    object_iterator end_members() { return evaluate().object_range().end(); }

    JSONCONS_DEPRECATED_MSG("Instead, use object_range().end()")
    const_object_iterator end_members() const { return evaluate().object_range().end(); }

    JSONCONS_DEPRECATED_MSG("Instead, use array_range().begin()")
    array_iterator begin_elements() { return evaluate().array_range().begin(); }

    JSONCONS_DEPRECATED_MSG("Instead, use array_range().begin()")
    const_array_iterator begin_elements() const { return evaluate().array_range().begin(); }

    JSONCONS_DEPRECATED_MSG("Instead, use array_range().end()")
    array_iterator end_elements() { return evaluate().array_range().end(); }

    JSONCONS_DEPRECATED_MSG("Instead, use array_range().end()")
    const_array_iterator end_elements() const { return evaluate().array_range().end(); }
    ...
    JSONCONS_DEPRECATED_MSG("Instead, use contains(const string_view_type&)")
    bool has_member(const string_view_type & name) const noexcept { return contains(name); }
    ...
    void remove(const string_view_type & name) { evaluate().remove(name); }
    JSONCONS_DEPRECATED_MSG("Instead, use erase(const string_view_type& name)")
    void remove_member(const string_view_type & name) { evaluate().remove(name); }
...
private:
  ...
  empty_object_storage & cast(identity<empty_object_storage>) { return empty_object_stor_; }
  ...
  const int64_storage & cast(identity<int64_storage>) const { return int64_stor_; }

  uint64_storage & cast(identity<uint64_storage>) { return uint64_stor_; }

  const uint64_storage & cast(identity<uint64_storage>) const { return uint64_stor_; }
  ...
  const double_storage & cast(identity<double_storage>) const { return double_stor_; }

  short_string_storage & cast(identity<short_string_storage>) { return short_string_stor_; }
  ...
  long_string_storage & cast(identity<long_string_storage>) { return long_string_stor_; }
  ...
  byte_string_storage & cast(identity<byte_string_storage>) { return byte_string_stor_; }
  ...
  const object_storage & cast(identity<object_storage>) const { return object_stor_; }

  array_storage & cast(identity<array_storage>) { return array_stor_; }

  const array_storage & cast(identity<array_storage>) const { return array_stor_; }
  ...
  void uninitialized_move_a(
    std::true_type /* stateless allocator */, basic_json && other, const Allocator &) noexcept
  {
    uninitialized_move(std::move(other));
  }

  void uninitialized_move_a(
    std::false_type /* stateful allocator */, basic_json && other, const Allocator & alloc) noexcept
  {
    switch (other.storage_kind()) {
      case json_storage_kind::null_value:
      case json_storage_kind::empty_object_value:
  ...
  void copy_assignment_l_r(
    identity<long_string_storage>, identity<long_string_storage>, const basic_json & other)
  {
    cast<long_string_storage>().assign(other.cast<long_string_storage>());
  }

  void copy_assignment_l_r(
    identity<byte_string_storage>, identity<byte_string_storage>, const basic_json & other)
  {
    cast<byte_string_storage>().assign(other.cast<byte_string_storage>());
  }

  void copy_assignment_l_r(
    identity<array_storage>, identity<array_storage>, const basic_json & other)
  {
    cast<array_storage>().assign(other.cast<array_storage>());
  }

  void copy_assignment_l_r(
    identity<object_storage>, identity<object_storage>, const basic_json & other)
  {
  ...
  void copy_assignment_r(const basic_json & other)
  {
    switch (storage_kind()) {
      case json_storage_kind::null_value:
        copy_assignment_l_r<null_storage, TypeR>(other);
        break;
      case json_storage_kind::empty_object_value:
        copy_assignment_l_r<empty_object_storage, TypeR>(other);
        break;
      case json_storage_kind::bool_value:
        copy_assignment_l_r<bool_storage, TypeR>(other);
        break;
      case json_storage_kind::int64_value:
        copy_assignment_l_r<int64_storage, TypeR>(other);
        break;
      case json_storage_kind::uint64_value:
        copy_assignment_l_r<uint64_storage, TypeR>(other);
        break;
      case json_storage_kind::half_value:
        copy_assignment_l_r<half_storage, TypeR>(other);
        break;
      case json_storage_kind::double_value:
        copy_assignment_l_r<double_storage, TypeR>(other);
        break;
      case json_storage_kind::short_string_value:
        copy_assignment_l_r<short_string_storage, TypeR>(other);
        break;
      case json_storage_kind::json_const_pointer:
        copy_assignment_l_r<json_const_pointer_storage, TypeR>(other);
        break;
      case json_storage_kind::long_string_value:
        copy_assignment_l_r<long_string_storage, TypeR>(other);
        break;
      case json_storage_kind::byte_string_value:
        copy_assignment_l_r<byte_string_storage, TypeR>(other);
        break;
      case json_storage_kind::array_value:
        copy_assignment_l_r<array_storage, TypeR>(other);
        break;
      case json_storage_kind::object_value:
        copy_assignment_l_r<object_storage, TypeR>(other);
        break;
      default:
        JSONCONS_UNREACHABLE();
        break;
  ...
  void move_assignment_l_r(
    identity<long_string_storage>, identity<long_string_storage>, basic_json && other)
  {
    cast<long_string_storage>().assign(std::move(other.cast<long_string_storage>()));
  }

  void move_assignment_l_r(
    identity<byte_string_storage>, identity<byte_string_storage>, basic_json && other)
  {
  ...
  void move_assignment_r(basic_json && other)
  {
    switch (storage_kind()) {
      case json_storage_kind::null_value:
        move_assignment_l_r<null_storage, TypeR>(std::move(other));
        break;
      case json_storage_kind::empty_object_value:
        move_assignment_l_r<empty_object_storage, TypeR>(std::move(other));
        break;
      case json_storage_kind::bool_value:
        move_assignment_l_r<bool_storage, TypeR>(std::move(other));
        break;
      case json_storage_kind::int64_value:
        move_assignment_l_r<int64_storage, TypeR>(std::move(other));
        break;
      case json_storage_kind::uint64_value:
        move_assignment_l_r<uint64_storage, TypeR>(std::move(other));
        break;
      case json_storage_kind::half_value:
        move_assignment_l_r<half_storage, TypeR>(std::move(other));
        break;
      case json_storage_kind::double_value:
        move_assignment_l_r<double_storage, TypeR>(std::move(other));
        break;
      case json_storage_kind::short_string_value:
        move_assignment_l_r<short_string_storage, TypeR>(std::move(other));
        break;
      case json_storage_kind::json_const_pointer:
        move_assignment_l_r<json_const_pointer_storage, TypeR>(std::move(other));
        break;
      case json_storage_kind::long_string_value:
        move_assignment_l_r<long_string_storage, TypeR>(std::move(other));
        break;
      case json_storage_kind::byte_string_value:
        move_assignment_l_r<byte_string_storage, TypeR>(std::move(other));
        break;
      case json_storage_kind::array_value:
        move_assignment_l_r<array_storage, TypeR>(std::move(other));
        break;
      case json_storage_kind::object_value:
        move_assignment_l_r<object_storage, TypeR>(std::move(other));
        break;
      default:
        JSONCONS_UNREACHABLE();
        break;
  ...
  const basic_json & evaluate(const string_view_type & name) const { return at(name); }
...
public:
    ...
    switch (storage_kind()) {
      case json_storage_kind::short_string_value:
        return string_view_type(
          cast<short_string_storage>().data(), cast<short_string_storage>().length());
      case json_storage_kind::long_string_value:
        return string_view_type(
          cast<long_string_storage>().data(), cast<long_string_storage>().length());
      case json_storage_kind::json_const_pointer:
    ...
    switch (storage_kind()) {
      ...
      case json_storage_kind::byte_string_value:
        return basic_byte_string<BAllocator>(
          cast<byte_string_storage>().data(), cast<byte_string_storage>().length());
      case json_storage_kind::json_const_pointer:
  ...
  int compare(const basic_json & rhs) const noexcept
  {
    ...
    switch (storage_kind()) {
      ...
      case json_storage_kind::int64_value:
        switch (rhs.storage_kind()) {
          case json_storage_kind::int64_value: {
            if (cast<int64_storage>().value() == rhs.cast<int64_storage>().value()) return 0;
          ...
          case json_storage_kind::uint64_value:
            if (cast<int64_storage>().value() < 0)
              ...
              static_cast<uint64_t>(cast<int64_storage>().value()) ==
      ...
      case json_storage_kind::long_string_value:
        switch (tag()) {
          ...
          case semantic_tag::bigfloat: {
            // same text -> equal
            if (
              rhs.storage_kind() == json_storage_kind::short_string_value ||
              rhs.storage_kind() == json_storage_kind::long_string_value) {
  ...
  static typename std::enable_if<
    extension_traits::is_sequence_of<Source, char_type>::value, basic_json>::type
  parse(
    const Source & source,
    const basic_json_decode_options<char_type> & options = basic_json_decode_options<char_type>())
  {
    ...
    if (!(r.encoding == unicode_traits::encoding_kind::utf8 ||
      ...
      JSONCONS_THROW(
        ser_error(json_errc::illegal_unicode_character, parser.line(), parser.column()));
    }
  ...
  static typename std::enable_if<
    extension_traits::is_sequence_of<Source, char_type>::value, basic_json>::type
  parse(
    const allocator_set<allocator_type, TempAllocator> & alloc_set, const Source & source,
    const basic_json_decode_options<char_type> & options = basic_json_decode_options<char_type>())
  {
  ...
  static basic_json parse(
    const allocator_set<allocator_type, TempAllocator> & alloc_set, const char_type * source,
    const basic_json_decode_options<char_type> & options = basic_json_decode_options<char_type>())
  {
  ...
  static basic_json parse(
    const char_type * s, std::function<bool(json_errc, const ser_context &)> err_handler)
  {
    return parse(
      jsoncons::basic_string_view<char_type>(s), basic_json_decode_options<char_type>(),
      err_handler);
  }
    ...
    const basic_json_decode_options<char_type> & options = basic_json_decode_options<CharT>())
  {
    ...
    basic_json_reader<char_type, iterator_source<InputIt>, Allocator> reader(
      iterator_source<InputIt>(std::forward<InputIt>(first), std::forward<InputIt>(last)), decoder,
      options);
    reader.read_next();
    reader.check_done();
    if (!decoder.is_valid()) {
  ...
  static basic_json parse(
    const allocator_set<allocator_type, TempAllocator> & alloc_set, InputIt first, InputIt last,
    const basic_json_decode_options<char_type> & options = basic_json_decode_options<CharT>())
  {
    json_decoder<basic_json> decoder(alloc_set.get_allocator(), alloc_set.get_temp_allocator());
    basic_json_reader<char_type, iterator_source<InputIt>, Allocator> reader(
  ...
  static basic_json parse(
    std::basic_istream<char_type> & is, const basic_json_decode_options<char_type> & options,
    std::function<bool(json_errc, const ser_context &)> err_handler)
  {
    json_decoder<basic_json> decoder;
  ...
  template <class InputIt>
  static basic_json parse(
    InputIt first, InputIt last, const basic_json_decode_options<char_type> & options,
    std::function<bool(json_errc, const ser_context &)> err_handler)
  {
    json_decoder<basic_json> decoder;
  ...
  static typename std::enable_if<
    extension_traits::is_sequence_of<Source, char_type>::value, basic_json>::type
  parse(
    const Source & source, const basic_json_decode_options<char_type> & options,
    std::function<bool(json_errc, const ser_context &)> err_handler)
  {
    json_decoder<basic_json> decoder;
  ...
  static typename std::enable_if<
    extension_traits::is_sequence_of<Source, char_type>::value, basic_json>::type
  parse(const Source & source, std::function<bool(json_errc, const ser_context &)> err_handler)
  {
  ...
  template <class InputIt>
  static basic_json parse(
    InputIt first, InputIt last, std::function<bool(json_errc, const ser_context &)> err_handler)
  {
  ...
  static basic_json make_array(
    std::initializer_list<basic_json> init, const Allocator & alloc = Allocator())
  {
  ...
  explicit basic_json(const Allocator &) { construct<empty_object_storage>(semantic_tag::none); }
  ...
  basic_json(basic_json && other) noexcept { uninitialized_move(std::move(other)); }
  ...
  explicit basic_json(json_object_arg_t, semantic_tag tag, const Allocator & alloc = Allocator())
  {
  ...
  template <class InputIt>
  basic_json(
    json_object_arg_t, InputIt first, InputIt last, semantic_tag tag = semantic_tag::none,
  ...
  explicit basic_json(json_array_arg_t, semantic_tag tag, const Allocator & alloc = Allocator())
  {
  ...
  template <class InputIt>
  basic_json(
    json_array_arg_t, InputIt first, InputIt last, semantic_tag tag = semantic_tag::none,
    const Allocator & alloc = Allocator())
  {
  ...
  basic_json(
    json_array_arg_t, std::initializer_list<basic_json> init, semantic_tag tag = semantic_tag::none,
    const Allocator & alloc = Allocator())
  {
  ...
  template <
    class T,
    class = typename std::enable_if<
      !is_proxy_of<T, basic_json>::value && !extension_traits::is_basic_json<T>::value>::type>
  basic_json(const T & val) : basic_json(json_type_traits<basic_json, T>::to_json(val))
  {
  }
  ...
  basic_json(double val, semantic_tag tag) { construct<double_storage>(val, tag); }
  ...
  template <class IntegerType>
  basic_json(
    IntegerType val, semantic_tag tag,
    typename std::enable_if<
  ...
  template <class IntegerType>
  basic_json(
    IntegerType val, semantic_tag tag, Allocator,
    typename std::enable_if<
      extension_traits::is_unsigned_integer<IntegerType>::value &&
        sizeof(IntegerType) <= sizeof(uint64_t),
      int>::type = 0)
  ...
  template <class IntegerType>
  basic_json(
    IntegerType val, semantic_tag, Allocator alloc = Allocator(),
    typename std::enable_if<
      extension_traits::is_unsigned_integer<IntegerType>::value &&
      ...
      int>::type = 0)
  {
    ...
    if (s.length() <= short_string_storage::max_length) {
      construct<short_string_storage>(
        semantic_tag::bigint, s.data(), static_cast<uint8_t>(s.length()));
    } else {
  ...
  basic_json(null_type, semantic_tag tag, const Allocator &) { construct<null_storage>(tag); }

  basic_json(bool val, semantic_tag tag) { construct<bool_storage>(val, tag); }

  basic_json(bool val, semantic_tag tag, const Allocator &) { construct<bool_storage>(val, tag); }

  basic_json(
    const string_view_type & sv, semantic_tag tag, const allocator_type & alloc = allocator_type())
  ...
  template <class Source>
  basic_json(
    byte_string_arg_t, const Source & source, semantic_tag tag = semantic_tag::none,
    const Allocator & alloc = Allocator(),
  ...
  typename std::enable_if<
    extension_traits::is_back_insertable_char_container<CharContainer>::value>::type
  dump_pretty(
    CharContainer & cont, const basic_json_encode_options<char_type> & options,
  ...
  void dump_pretty(std::basic_ostream<char_type> & os, std::error_code & ec) const
  {
  ...
  dump(
    ...
    std::error_code & ec) const
  {
    basic_compact_json_encoder<char_type, jsoncons::string_sink<CharContainer>> encoder(
      cont, options);
    dump(encoder, ec);
  }
  ...
  typename std::enable_if<
    extension_traits::is_back_insertable_char_container<CharContainer>::value>::type
  dump(
    CharContainer & cont, const basic_json_encode_options<char_type> & options, indenting indent,
    std::error_code & ec) const
  {
  ...
  void dump(std::basic_ostream<char_type> & os, indenting indent, std::error_code & ec) const
  {
    if (indent == indenting::indent) {
      dump_pretty(os, ec);
    } else {
  ...
  {
    JSONCONS_THROW(
      json_runtime_error<std::domain_error>(
        "Cannot create object implicitly - allocator is stateful."));
  }

  void create_object_implicitly(std::true_type) { *this = basic_json(json_object_arg, tag()); }
  ...
  template <class T>
  typename std::enable_if<is_json_type_traits_specialized<basic_json, T>::value, T>::type as() const
  {
  ...
  IntegerType as_integer() const
  {
    switch (storage_kind()) {
      ...
      case json_storage_kind::long_string_value: {
        IntegerType val;
        auto result =
          jsoncons::detail::to_integer(as_string_view().data(), as_string_view().length(), val);
        if (!result) {
    ...
    switch (storage_kind()) {
      case json_storage_kind::int64_value:
        return (as_integer<int64_t>() >=
               ...
               (as_integer<int64_t>() <= (extension_traits::integer_limits<IntegerType>::max)());
      case json_storage_kind::uint64_value:
        return as_integer<uint64_t>() <=
               static_cast<uint64_t>((extension_traits::integer_limits<IntegerType>::max)());
      case json_storage_kind::json_const_pointer:
  ...
  basic_json & at(std::size_t i)
  {
    switch (storage_kind()) {
      ...
      default:
        JSONCONS_THROW(
          json_runtime_error<std::domain_error>("Index on non-array value not supported"));
    }
  }
  ...
  T get_value_or(const string_view_type & key, U && default_value) const
  {
    static_assert(
      std::is_copy_constructible<T>::value, "get_value_or: T must be copy constructible");
    static_assert(std::is_convertible<U &&, T>::value, "get_value_or: U must be convertible to T");
    switch (storage_kind()) {
      case json_storage_kind::null_value:
      case json_storage_kind::empty_object_value:
      ...
      case json_storage_kind::json_const_pointer:
        return cast<json_const_pointer_storage>().value()->template get_value_or<T, U>(
          key, std::forward<U>(default_value));
      default: {
        JSONCONS_THROW(not_an_object(key.data(), key.length()));
      }
    }
  ...
  // Removes all elements from an array value whose index is between from_index, inclusive, and
  // to_index, exclusive.
    ...
    switch (storage_kind()) {
      case json_storage_kind::empty_object_value:
        ...
        return object_iterator(
          cast<object_storage>().value().insert_or_assign(hint, name, std::forward<T>(val)));
      case json_storage_kind::object_value:
        return object_iterator(
          cast<object_storage>().value().insert_or_assign(hint, name, std::forward<T>(val)));
      default:
  ...
  object_iterator try_emplace(object_iterator hint, const string_view_type & name, Args &&... args)
  {
    switch (storage_kind()) {
      case json_storage_kind::empty_object_value:
        create_object_implicitly();
        return object_iterator(
          cast<object_storage>().value().try_emplace(hint, name, std::forward<Args>(args)...));
      case json_storage_kind::object_value:
        return object_iterator(
          cast<object_storage>().value().try_emplace(hint, name, std::forward<Args>(args)...));
      default:
...
#if !defined(JSONCONS_NO_DEPRECATED)
  JSONCONS_DEPRECATED_MSG(
    "Instead, use basic_json(byte_string_arg_t, const Source&, "
    "semantic_tag=semantic_tag::none,const Allocator& = Allocator())")
  basic_json(
    const byte_string_view & bytes, semantic_tag tag, const Allocator & alloc = Allocator())
  ...
  // JSONCONS_DEPRECATED_MSG("Instead, use parse(const string_view_type&, const
  // basic_json_options<char_type>&)") static basic_json parse(const char_type* s, std::size_t
  // length, std::function<bool(json_errc,const ser_context&)> err_handler)
  //{
  ...
  JSONCONS_DEPRECATED_MSG(
    "Instead, use parse(std::basic_istream<char_type>&, const basic_json_options<char_type>&)>)")
  static basic_json parse_file(
    const std::basic_string<char_type, char_traits_type> & filename,
    std::function<bool(json_errc, const ser_context &)> err_handler)
  {
    std::basic_ifstream<char_type> is(filename);
  ...
  JSONCONS_DEPRECATED_MSG("Instead, use parse(std::basic_istream<char_type>&)")
  static basic_json parse_stream(std::basic_istream<char_type> & is) { return parse(is); }
  JSONCONS_DEPRECATED_MSG(
    "Instead, use parse(std::basic_istream<char_type>&, std::function<bool(json_errc,const "
    "ser_context&)>)")
  static basic_json parse_stream(
    std::basic_istream<char_type> & is,
    std::function<bool(json_errc, const ser_context &)> err_handler)
  {
  ...
  JSONCONS_DEPRECATED_MSG("Instead, use parse(const string_view_type&)")
  static basic_json parse_string(const string_view_type & s) { return parse(s); }

  JSONCONS_DEPRECATED_MSG(
    "Instead, use parse(parse(const string_view_type&, std::function<bool(json_errc,const "
    "ser_context&)>)")
  static const basic_json parse_string(
    const string_view_type & s, std::function<bool(json_errc, const ser_context &)> err_handler)
  {
    return parse(s, err_handler);
  }

  JSONCONS_DEPRECATED_MSG("Instead, use basic_json(double)")
  basic_json(double val, uint8_t) : basic_json(val, semantic_tag::none) {}
  ...
  JSONCONS_DEPRECATED_MSG("Instead, use dump(basic_json_visitor<char_type>&)")
  void dump_fragment(basic_json_visitor<char_type> & visitor) const { dump(visitor); }

  JSONCONS_DEPRECATED_MSG("Instead, use dump(basic_json_visitor<char_type>&)")
  void dump_body(basic_json_visitor<char_type> & visitor) const { dump(visitor); }
  ...
  JSONCONS_DEPRECATED_MSG(
    "Instead, use dump(std::basic_ostream<char_type>&, const "
    "basic_json_encode_options<char_type>&, indenting)")
  void dump(
    std::basic_ostream<char_type> & os, const basic_json_encode_options<char_type> & options,
    bool pprint) const
  {
  ...
  JSONCONS_DEPRECATED_MSG("Instead, use dump(basic_json_visitor<char_type>&)")
  void write_body(basic_json_visitor<char_type> & visitor) const { dump(visitor); }

  JSONCONS_DEPRECATED_MSG("Instead, use dump(basic_json_visitor<char_type>&)")
  void write(basic_json_visitor<char_type> & visitor) const { dump(visitor); }

  JSONCONS_DEPRECATED_MSG("Instead, use dump(std::basic_ostream<char_type>&)")
  void write(std::basic_ostream<char_type> & os) const { dump(os); }

  JSONCONS_DEPRECATED_MSG(
    "Instead, use dump(std::basic_ostream<char_type>&, const "
    "basic_json_encode_options<char_type>&)")
  void write(
    std::basic_ostream<char_type> & os, const basic_json_encode_options<char_type> & options) const
  {
    dump(os, options);
  }
  ...
  JSONCONS_DEPRECATED_MSG("Instead, use dump(basic_json_visitor<char_type>&)")
  void to_stream(basic_json_visitor<char_type> & visitor) const { dump(visitor); }

  JSONCONS_DEPRECATED_MSG("Instead, use dump(std::basic_ostream<char_type>&)")
  void to_stream(std::basic_ostream<char_type> & os) const { dump(os); }
  ...
  JSONCONS_DEPRECATED_MSG("Instead, use tag() == semantic_tag::datetime")
  bool is_datetime() const noexcept { return tag() == semantic_tag::datetime; }

  JSONCONS_DEPRECATED_MSG("Instead, use tag() == semantic_tag::epoch_second")
  bool is_epoch_time() const noexcept { return tag() == semantic_tag::epoch_second; }

  JSONCONS_DEPRECATED_MSG("Instead, use contains(const string_view_type&)")
  bool has_key(const string_view_type & name) const noexcept { return contains(name); }

  JSONCONS_DEPRECATED_MSG("Instead, use as<uint64_t>()")
  uint64_t as_uinteger() const { return as<uint64_t>(); }
  ...
  JSONCONS_DEPRECATED_MSG("Instead, use resize(std::size_t)")
  void resize_array(std::size_t n) { resize(n); }
  ...
  JSONCONS_DEPRECATED_MSG("Instead, use object_range().begin()")
  object_iterator begin_members() { return object_range().begin(); }

  JSONCONS_DEPRECATED_MSG("Instead, use object_range().begin()")
  const_object_iterator begin_members() const { return object_range().begin(); }

  JSONCONS_DEPRECATED_MSG("Instead, use object_range().end()")
  object_iterator end_members() { return object_range().end(); }

  JSONCONS_DEPRECATED_MSG("Instead, use object_range().end()")
  const_object_iterator end_members() const { return object_range().end(); }

  JSONCONS_DEPRECATED_MSG("Instead, use array_range().begin()")
  array_iterator begin_elements() { return array_range().begin(); }

  JSONCONS_DEPRECATED_MSG("Instead, use array_range().begin()")
  const_array_iterator begin_elements() const { return array_range().begin(); }

  JSONCONS_DEPRECATED_MSG("Instead, use array_range().end()")
  array_iterator end_elements() { return array_range().end(); }

  JSONCONS_DEPRECATED_MSG("Instead, use array_range().end()")
  const_array_iterator end_elements() const { return array_range().end(); }
  ...
  JSONCONS_DEPRECATED_MSG("Instead, use is<long long>()")
  bool is_longlong() const noexcept { return is<long long>(); }

  JSONCONS_DEPRECATED_MSG("Instead, use is<unsigned long long>()")
  bool is_ulonglong() const noexcept { return is<unsigned long long>(); }

  JSONCONS_DEPRECATED_MSG("Instead, use as<long long>()")
  long long as_longlong() const { return as<long long>(); }

  JSONCONS_DEPRECATED_MSG("Instead, use as<unsigned long long>()")
  unsigned long long as_ulonglong() const { return as<unsigned long long>(); }

  JSONCONS_DEPRECATED_MSG("Instead, use as<int>()")
  int as_int() const { return as<int>(); }

  JSONCONS_DEPRECATED_MSG("Instead, use as<unsigned int>()")
  unsigned int as_uint() const { return as<unsigned int>(); }

  JSONCONS_DEPRECATED_MSG("Instead, use as<long>()")
  long as_long() const { return as<long>(); }

  JSONCONS_DEPRECATED_MSG("Instead, use as<unsigned long>()")
  unsigned long as_ulong() const { return as<unsigned long>(); }

  JSONCONS_DEPRECATED_MSG("Instead, use contains(const string_view_type&)")
  bool has_member(const string_view_type & key) const noexcept { return contains(key); }
  ...
  JSONCONS_DEPRECATED_MSG("Instead, use erase(const string_view_type& name)")
  void remove(const string_view_type & name) { erase(name); }

  JSONCONS_DEPRECATED_MSG("Instead, use erase(const string_view_type& name)")
  void remove_member(const string_view_type & name) { erase(name); }
  // Removes a member from an object value

  JSONCONS_DEPRECATED_MSG("Instead, use empty()")
  bool is_empty() const noexcept { return empty(); }
  JSONCONS_DEPRECATED_MSG("Instead, use is_number()")
  bool is_numeric() const noexcept { return is_number(); }

  JSONCONS_DEPRECATED_MSG("Instead, use object_range()")
  object_range_type members() { return object_range(); }

  JSONCONS_DEPRECATED_MSG("Instead, use object_range()")
  const_object_range_type members() const { return object_range(); }

  JSONCONS_DEPRECATED_MSG("Instead, use array_range()")
  array_range_type elements() { return array_range(); }

  JSONCONS_DEPRECATED_MSG("Instead, use array_range()")
  const_array_range_type elements() const { return array_range(); }

  JSONCONS_DEPRECATED_MSG("Instead, use storage_kind()")
  json_storage_kind get_stor_type() const { return storage_kind(); }
#endif
    ...
    switch (storage_kind()) {
      case json_storage_kind::array_value:
        return array_range_type(
          cast<array_storage>().value().begin(), cast<array_storage>().value().end());
      default:
        JSONCONS_THROW(json_runtime_error<std::domain_error>("Not an array"));
    }
  }
  ...
  void dump_noflush(basic_json_visitor<char_type> & visitor, std::error_code & ec) const
  {
    ...
    switch (storage_kind()) {
      ...
      case json_storage_kind::half_value:
        ...
        break;
      case json_storage_kind::double_value:
        visitor.double_value(cast<double_storage>().value(), tag(), context, ec);
        break;
      case json_storage_kind::int64_value:
...
template <class Json>
typename std::enable_if<extension_traits::is_basic_json<Json>::value, bool>::type operator==(
  const Json & lhs, const Json & rhs) noexcept
{
...
typename std::enable_if<
  extension_traits::is_basic_json<Json>::value && std::is_convertible<T, Json>::value, bool>::type
...
template <class Json, class T>
typename std::enable_if<
  extension_traits::is_basic_json<Json>::value && !is_proxy<T>::value &&
    !extension_traits::is_basic_json<T>::value && std::is_convertible<T, Json>::value,
  bool>::type
...
template <class Json, class T>
typename std::enable_if<
  is_proxy<Json>::value && !is_proxy<T>::value && !extension_traits::is_basic_json<T>::value &&
...
#if !defined(JSONCONS_NO_DEPRECATED)
JSONCONS_DEPRECATED_MSG("Instead, use wojson")
typedef basic_json<wchar_t, order_preserving_policy, std::allocator<wchar_t>> owjson;
JSONCONS_DEPRECATED_MSG("Instead, use json_decoder<json>")
typedef json_decoder<json> json_deserializer;
JSONCONS_DEPRECATED_MSG("Instead, use json_decoder<wjson>")
typedef json_decoder<wjson> wjson_deserializer;
JSONCONS_DEPRECATED_MSG("Instead, use json_decoder<ojson>")
typedef json_decoder<ojson> ojson_deserializer;
JSONCONS_DEPRECATED_MSG("Instead, use json_decoder<wojson>")
