...
public:
  using allocator_type = typename std::conditional<
    extension_traits::has_allocator_type<Into>::value, typename Into::allocator_type,
...
public:
  value_converter_base(const allocator_type & alloc = allocator_type()) : alloc_(alloc) {}
...
public:
  ...
  typename std::enable_if<extension_traits::is_narrow_character<CharT>::value, Into>::type convert(
    const From & value, semantic_tag tag, std::error_code &)
  {
  ...
  template <class CharT = typename Into::value_type>
  typename std::enable_if<extension_traits::is_wide_character<CharT>::value, Into>::type convert(
    const From & value, semantic_tag tag, std::error_code & ec)
  {
    std::string s;
    switch (tag) {
      case semantic_tag::base64:
...
class value_converter<
  ...
  typename std::enable_if<
    ...
    std::is_same<typename From::value_type, typename Into::value_type>::value>::type>
: value_converter_base<Into>
{
public:
  using allocator_type = typename value_converter_base<Into>::allocator_type;
...
class value_converter<
  From, Into,
  typename std::enable_if<
    extension_traits::is_integer<From>::value && extension_traits::is_string<Into>::value>::type>
: value_converter_base<Into>
{
public:
  using allocator_type = typename value_converter_base<Into>::allocator_type;
...
class value_converter<
  From, Into,
  typename std::enable_if<
    std::is_floating_point<From>::value && extension_traits::is_string<Into>::value>::type>
: value_converter_base<Into>
{
public:
  using allocator_type = typename value_converter_base<Into>::allocator_type;
...
template <class Into>
class value_converter<
  half_arg_t, Into, typename std::enable_if<extension_traits::is_string<Into>::value>::type>
: value_converter_base<Into>
{
public:
  using allocator_type = typename value_converter_base<Into>::allocator_type;
...
class value_converter<
  From, Into,
  typename std::enable_if<
    extension_traits::is_bool<From>::value && extension_traits::is_string<Into>::value>::type>
: value_converter_base<Into>
{
public:
  using allocator_type = typename value_converter_base<Into>::allocator_type;
