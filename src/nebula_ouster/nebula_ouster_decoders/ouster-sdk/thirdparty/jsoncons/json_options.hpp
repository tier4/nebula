...
public:
  ...
  bool enable_neginf_to_num() const { return enable_neginf_to_num_ || enable_inf_to_num_; }
  ...
  bool enable_neginf_to_str() const { return enable_neginf_to_str_ || enable_inf_to_str_; }

  bool enable_str_to_neginf() const { return enable_str_to_neginf_ || enable_str_to_inf_; }
  ...
  const string_type & pos_inf_replacement() const { return pos_inf_replacement_; }

  JSONCONS_DEPRECATED_MSG("Instead, use neginf_to_num() or neginf_to_str()")
  const string_type & neg_inf_replacement() const { return neg_inf_replacement_; }
#endif
};
...
public:
  basic_json_decode_options() : lossless_number_(false), err_handler_(default_json_parsing()) {}
...
public:
  ...
  JSONCONS_DEPRECATED_MSG(
    "Instead, use inf_to_num(const string_type&) or inf_to_str(const string_type&)")
  ...
  JSONCONS_DEPRECATED_MSG(
    "Instead, use neginf_to_num(const string_type&) or neginf_to_str(const string_type&)")
  ...
  JSONCONS_DEPRECATED_MSG(
    "Instead, use nan_to_num(const string_type&) or nan_to_str(const string_type&)")
