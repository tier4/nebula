...
public:
  ...
  OUSTER_API_FUNCTION
  Zrb(
    uint32_t n_rows, uint32_t n_cols, float m_per_zmbin, uint64_t serial_number, Sha256 stl_hash,
    const mat4d & beam_to_lidar, const mat4d & lidar_to_sensor, const mat4d & sensor_to_body);
