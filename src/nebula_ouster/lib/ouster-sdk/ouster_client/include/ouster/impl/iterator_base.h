...
public:
  ...
  {
    throw std::runtime_error("length is not supported on non-indexed scan sources.");
  }
};
...
public:
  BaseIterator(const Parent * parent, BaseIteratorImpl<T> * i) : parent_(parent) { impl_.reset(i); }
