...
public:
  AccumulatedPoint() : num_points_(0), point_(PointScalar(0.0), PointScalar(0.0), PointScalar(0.0))
  {
  }
  ...
  AttribVecT average_attrib() const { return attrib_ / AttribScalar(num_points_); }
