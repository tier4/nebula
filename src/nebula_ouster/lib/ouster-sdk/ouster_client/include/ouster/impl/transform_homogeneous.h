...
public:
  ...
  PoseH operator*(const PoseH & other) const { return PoseH(Eigen::Matrix4d::operator*(other)); }

  Eigen::Vector3d operator*(const Eigen::Vector3d & p) const { return RotH(r()) * p + t(); }
