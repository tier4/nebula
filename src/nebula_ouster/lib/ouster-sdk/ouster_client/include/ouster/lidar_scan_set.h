...
using ValidObjectIterator =
  ValidElementsIterator<T, typename std::vector<std::shared_ptr<T>>::iterator, false>;
...
using ValidObjectConstIterator =
  ValidElementsIterator<T, typename std::vector<std::shared_ptr<T>>::const_iterator, false>;
...
using ValidIndexIterator =
  ValidElementsIterator<T, typename std::vector<std::shared_ptr<T>>::iterator, true>;
/**
...
using ValidIndexConstIterator =
  ValidElementsIterator<T, typename std::vector<std::shared_ptr<T>>::const_iterator, true>;
...
public:
  ...
  {
    return ValidObjectConstIterator<LidarScan>(scans_.begin(), scans_.end());
  }
 ...
 */
OUSTER_API_FUNCTION
void swap(ouster::sdk::core::LidarScanSet & a, ouster::sdk::core::LidarScanSet & b);
