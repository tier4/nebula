...
using ScanIterator = ouster::sdk::core::impl::BaseIterator<LidarScanSet, ScanSource>;

/// Iterator implementation for ScanSources
using ScanIteratorImpl = ouster::sdk::core::impl::BaseIteratorImpl<LidarScanSet>;
...
public:
  ...
  OUSTER_API_FUNCTION
  virtual ScanIterator begin(
    int sensor_index  ///< [in] sensor index
  ) const = 0;
