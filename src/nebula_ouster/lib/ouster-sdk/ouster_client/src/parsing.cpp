...
FieldInfo field_info(
  size_t bit_start, size_t bit_size, size_t upshift = 0, [[maybe_unused]] size_t max_length = 0,
...
void PacketWriter::set_block(
  const T * data, int cols, const std::string & field_name, uint8_t * lidar_buf) const
{
