...
public:
   ...
   */
  OUSTER_API_FUNCTION
  inline const ouster::sdk::core::Version & firmware_version() const { return version_; }
  ...
  virtual void set_static_ip(
    const std::string & ip_address, int timeout_sec = SHORT_HTTP_REQUEST_TIMEOUT_SECONDS) const = 0;
