...
public:
  ...
  OUSTER_API_FUNCTION
  Collator(
    std::unique_ptr<ScanSource> source,  ///< [in] source to collate
  ...
  OUSTER_API_FUNCTION
  const std::vector<std::vector<std::pair<uint64_t, uint64_t>>> & individual_index() const override;
...
public:
  ...
  OUSTER_API_FUNCTION
  Singler(
    const ScanSource & source,  ///< [in] source to single
...
public:
  ...
  OUSTER_API_FUNCTION
  Slicer(
    const ScanSource & source,  ///< [in] source to slice
...
public:
  ...
  OUSTER_API_FUNCTION
  AnyScanSource(
    std::unique_ptr<ScanSource> source  ///< [in] the source to wrap and take ownership of
  );
...
public:
  ...
  OUSTER_API_FUNCTION
  MultiScanSource(
    std::vector<std::shared_ptr<ScanSource>> sources  ///< [in] the sources to combine
  );
