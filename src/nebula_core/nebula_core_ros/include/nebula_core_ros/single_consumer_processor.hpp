...
public:
  ...
  /// Creates the consumer thread from a given thread body. Allows callers to integrate the
  /// consumer thread with external thread management frameworks (e.g. to control its scheduling
