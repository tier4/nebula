...
#ifndef NEBULA_CORE_HW_INTERFACES__CONNECTIONS__TCP_HPP_
// See `man strerror_r`
#define NEBULA_CORE_HW_INTERFACES__CONNECTIONS__TCP_HPP_
#endif  // NEBULA_CORE_HW_INTERFACES__CONNECTIONS__TCP_HPP_
