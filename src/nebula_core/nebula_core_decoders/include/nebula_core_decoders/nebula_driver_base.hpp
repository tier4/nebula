...
#ifndef NEBULA_CORE_DECODERS__NEBULA_DRIVER_BASE_HPP_
#define NEBULA_CORE_DECODERS__NEBULA_DRIVER_BASE_HPP_
...
#endif  // NEBULA_CORE_DECODERS__NEBULA_DRIVER_BASE_HPP_
