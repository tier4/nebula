  ...
  drivers::continental_srr520::ContinentalSrr520SensorConfiguration & sensor_configuration)
{
  ...
  bag_root_dir /= "continental";
  {
    ...
    this->declare_parameter<std::string>("sensor_model", "SRR520");
  ...
  }
  {
    ...
    this->declare_parameter<std::string>(
      "bag_path", (bag_root_dir / "srr520" / "1708578209").string(), descriptor);
  ...
  }
  {
    ...
    descriptor.additional_constraints = "";
    this->declare_parameter<std::string>(
      "target_topic", "/sensing/radar/front_left/nebula_packets", descriptor);
