  ...
  drivers::RobosenseCalibrationConfiguration & calibration_configuration)
{
  ...
  bag_root_dir /= "robosense";
  {
    ...
    this->declare_parameter<std::string>("sensor_model", "RobosenseE1");
  ...
  }
  {
    ...
    this->declare_parameter<std::string>(
      "calibration_file", (calib_dir / "RobosenseE1.csv").string(), descriptor);
  ...
  }
  {
    ...
    descriptor.additional_constraints = "";
    this->declare_parameter<std::string>(
      "bag_path", (bag_root_dir / "e1" / "rosbag2_2023_08_30-19_00_48").string(), descriptor);
