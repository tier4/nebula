#ifndef NEBULA_RobosenseRosDecoderTestHelios_H
#define NEBULA_RobosenseRosDecoderTestHelios_H
...
namespace ros
{
/// @brief Testing decoder of Helios (Keeps RobosenseDriverRosWrapper structure as much as possible)
                                      ...
                                      NebulaDriverRosWrapperBase  //, testing::Test
{
  ...
  /// @brief Get configurations (Magic numbers for Helios is described, each function can be
...
#endif  // NEBULA_RobosenseRosDecoderTestHelios_H
