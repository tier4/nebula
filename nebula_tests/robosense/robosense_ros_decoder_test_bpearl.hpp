#ifndef NEBULA_RobosenseRosDecoderTestBpearl_H
#define NEBULA_RobosenseRosDecoderTestBpearl_H
...
namespace ros
{
/// @brief Testing decoder of Bpearl (Keeps RobosenseDriverRosWrapper structure as much as possible)
                                      ...
                                      NebulaDriverRosWrapperBase  //, testing::Test
{
  ...
  /// @brief Get configurations (Magic numbers for Bpearl is described, each function can be
...
#endif  // NEBULA_RobosenseRosDecoderTestBpearl_H
