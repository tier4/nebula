#ifndef NEBULA_RobosenseRosDecoderTestM1Plus_H
#define NEBULA_RobosenseRosDecoderTestM1Plus_H
...
namespace ros
{
/// @brief Testing decoder of M1Plus (Keeps RobosenseDriverRosWrapper structure as much as possible)
                                      ...
                                      NebulaDriverRosWrapperBase  //, testing::Test
{
  ...
  /// @brief Get configurations (Magic numbers for M1Plus is described, each function can be
...
#endif  // NEBULA_RobosenseRosDecoderTestM1Plus_H
