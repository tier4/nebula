#include "robosense_ros_decoder_test_helios.hpp"
  ...
  drivers::RobosenseCalibrationConfiguration & calibration_configuration)
{
  ...
  bag_root_dir /= "robosense";
  {
    ...
    this->declare_parameter<std::string>("sensor_model", "RobosenseHelios");
  ...
  }
  {
    ...
    this->declare_parameter<std::string>(
      "calibration_file", (calib_dir / "RobosenseHelios.csv").string(), descriptor);
  ...
  }
  {
    ...
    descriptor.additional_constraints = "";
    this->declare_parameter<std::string>(
      "bag_path", (bag_root_dir / "helios" / "rosbag2_2023_08_04-17_36_03").string(), descriptor);
