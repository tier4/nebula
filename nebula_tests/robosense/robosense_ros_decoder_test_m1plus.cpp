#include "robosense_ros_decoder_test_m1plus.hpp"
  ...
  drivers::RobosenseCalibrationConfiguration & calibration_configuration)
{
  ...
  bag_root_dir /= "robosense";
  {
    ...
    this->declare_parameter<std::string>("sensor_model", "RobosenseM1Plus");
  ...
  }
  {
    ...
    this->declare_parameter<std::string>(
      "calibration_file", (calib_dir / "RobosenseM1Plus.csv").string(), descriptor);
  ...
  }
  {
    ...
    descriptor.additional_constraints = "";
    this->declare_parameter<std::string>(
      "bag_path", (bag_root_dir / "m1plus" / "rosbag2_2023_08_28-16_31_11").string(), descriptor);
