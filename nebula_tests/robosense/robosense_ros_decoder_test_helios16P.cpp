#include "robosense_ros_decoder_test_helios16P.hpp"
  ...
  drivers::RobosenseCalibrationConfiguration & calibration_configuration)
{
  ...
  bag_root_dir /= "robosense";
  {
    ...
    this->declare_parameter<std::string>("sensor_model", "RobosenseHelios16P");
  ...
  }
  {
    ...
    this->declare_parameter<std::string>(
      "calibration_file", (calib_dir / "RobosenseHelios16P.csv").string(), descriptor);
  ...
  }
  {
    ...
    descriptor.additional_constraints = "";
    this->declare_parameter<std::string>(
      "bag_path", (bag_root_dir / "helios16P" / "rosbag2_2023_08_03-11_02_46").string(),
      descriptor);
