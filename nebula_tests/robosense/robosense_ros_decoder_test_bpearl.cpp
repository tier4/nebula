#include "robosense_ros_decoder_test_bpearl.hpp"
  ...
  drivers::RobosenseCalibrationConfiguration & calibration_configuration)
{
  ...
  bag_root_dir /= "robosense";
  {
    ...
    this->declare_parameter<std::string>("sensor_model", "RobosenseBpearl");
  ...
  }
  {
    ...
    this->declare_parameter<std::string>(
      "calibration_file", (calib_dir / "RobosenseBpearl.csv").string(), descriptor);
  ...
  }
  {
    ...
    descriptor.additional_constraints = "";
    this->declare_parameter<std::string>(
      "bag_path", (bag_root_dir / "bpearl" / "rosbag2_2023_08_25-09_49_31").string(), descriptor);
