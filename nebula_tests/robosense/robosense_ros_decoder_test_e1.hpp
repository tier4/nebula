#ifndef NEBULA_RobosenseRosDecoderTestE1_H
#define NEBULA_RobosenseRosDecoderTestE1_H
...
namespace ros
{
/// @brief Testing decoder of E1 (Keeps RobosenseDriverRosWrapper structure as much as possible)
                                      ...
                                      NebulaDriverRosWrapperBase  //, testing::Test
{
  ...
  /// @brief Get configurations (Magic numbers for E1 is described, each function can be
...
#endif  // NEBULA_RobosenseRosDecoderTestE1_H
