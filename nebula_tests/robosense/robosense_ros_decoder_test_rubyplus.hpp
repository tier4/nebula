#ifndef NEBULA_RobosenseRosDecoderTestRubyPlus_H
#define NEBULA_RobosenseRosDecoderTestRubyPlus_H
...
namespace ros
{
/// @brief Testing decoder of RubyPlus (Keeps RobosenseDriverRosWrapper structure as much as
/// possible)
                                      ...
                                      NebulaDriverRosWrapperBase  //, testing::Test
{
  ...
  /// @brief Get configurations (Magic numbers for RubyPlus is described, each function can be
...
#endif  // NEBULA_RobosenseRosDecoderTestRubyPlus_H
