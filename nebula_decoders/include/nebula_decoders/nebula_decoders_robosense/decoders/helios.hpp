...
{
private:
  static constexpr int firing_time_offset_ns_[12][32] = {
...
public:
  ...
  int getPacketRelativePointTimeOffset(
    uint32_t block_id, uint32_t channel_id, const bool & isSingleReturn) override
  {
    return firing_time_offset_ns_[block_id][channel_id];
  }
};
