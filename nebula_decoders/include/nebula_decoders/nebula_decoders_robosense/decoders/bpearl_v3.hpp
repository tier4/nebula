...
class BpearlV3 : public SensorBase<robosense_packet::bpearl_v3::Packet>,
  ...
  public ChannelIsUnitMixin<robosense_packet::bpearl_v3::Packet>,
  public NonZeroDistanceIsValidMixin<robosense_packet::bpearl_v3::Packet>,
  public AngleBasedScanCompletionMixin<robosense_packet::bpearl_v3::Packet, RobosenseSensorConfiguration>,
...
public:
  typedef typename robosense_packet::bpearl_v3::InfoPacket info_t;
  ...
  BpearlV3(const std::shared_ptr<RobosenseSensorConfiguration> sensor_config, const std::shared_ptr<const RobosenseCalibrationConfiguration> & calibration_config)
  ...
  ReturnMode getReturnMode(const robosense_packet::bpearl_v3::InfoPacket & info_packet) const
  {
  ...
  RobosenseCalibrationConfiguration getSensorCalibration(
    const robosense_packet::bpearl_v3::InfoPacket & info_packet) const
  {
    return info_packet.sensor_calibration.getCalibration();
  }

  bool getSyncStatus(const robosense_packet::bpearl_v3::InfoPacket & info_packet) const
  {
