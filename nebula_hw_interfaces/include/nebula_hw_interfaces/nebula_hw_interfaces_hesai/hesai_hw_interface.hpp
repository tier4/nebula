...
public:
  ...
  /// @param enable Enable retro multi-reflection filtering
  /// @return Resulting status
  Status set_retro_multi_reflection_filtering(bool enable);
  /// @brief Getting values with PTC_COMMAND_GET_RETRO_MULTI_REFLECTION_FILTERING
  /// @return Resulting status
  bool get_retro_multi_reflection_filtering();
