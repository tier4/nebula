...
struct ContinentalARS548Status
{
  ...
  std::string status_longitudinal_velocity;
  std::string status_longitudinal_acceleration;
  std::string status_lateral_acceleration;
  ...
  friend std::ostream & operator<<(std::ostream & os, nebula::ContinentalARS548Status const & arg)
  {
    ...
    os << ", ";
    os << "status_longitudinal_velocity: " << arg.status_longitudinal_velocity;
    os << ", ";
    os << "status_longitudinal_acceleration: " << arg.status_longitudinal_acceleration;
    os << ", ";
    os << "status_lateral_acceleration: " << arg.status_lateral_acceleration;
    os << ", ";
    os << "status_yaw_rate: " << arg.status_yaw_rate;
    os << ", ";
