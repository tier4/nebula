...
#include "robosense_msgs/msg/robosense_monitor_info.hpp"
...
private:  // ROS Diagnostics
  ...
  /// @brief Getting  bot_fpga_temperature from the current RobosenseMonitorInfo msg
  /// @return tuple<Got exeption, Error level, Information message, Error message>
  std::tuple<bool, uint8_t, std::string, std::string> RobosenseGetBotFpgaTemperature();
  /// @brief Getting  recv_A_temperature from the current RobosenseMonitorInfo msg
  /// @return tuple<Got exeption, Error level, Information message, Error message>
  std::tuple<bool, uint8_t, std::string, std::string> RobosenseGetRecvATemperature();
  /// @brief Getting  recv_B_temperature from the current RobosenseMonitorInfo msg
  /// @return tuple<Got exeption, Error level, Information message, Error message>
  std::tuple<bool, uint8_t, std::string, std::string> RobosenseGetRecvBTemperature();
  /// @brief Getting  main_fpga_temperature from the current RobosenseMonitorInfo msg
  /// @return tuple<Got exeption, Error level, Information message, Error message>
  std::tuple<bool, uint8_t, std::string, std::string> RobosenseGetMainFpgaTemperature();
  /// @brief Getting  main_fpga_core_temperature from the current RobosenseMonitorInfo msg
  /// @return tuple<Got exeption, Error level, Information message, Error message>
  std::tuple<bool, uint8_t, std::string, std::string> RobosenseGetMainCoreFpgaTemperature();
  /// @brief Getting lane up from the current RobosenseMonitorInfo msg
  /// @return tuple<Got exeption, Error level, Information message, Error message>
  std::tuple<bool, uint8_t, std::string, std::string> RobosenseGetLaneUp();
  /// @brief Getting lane up cnt from the current RobosenseMonitorInfo msg
  /// @return tuple<Got exeption, Error level, Information message, Error message>
  std::tuple<bool, uint8_t, std::string, std::string> RobosenseGetLaneUpCnt();
  /// @brief Getting lane up cnt from the current RobosenseMonitorInfo msg
  /// @return tuple<Got exeption, Error level, Information message, Error message>
  std::tuple<bool, uint8_t, std::string, std::string> RobosenseCheckMainStatus();
  /// @brief Getting gps status from the current RobosenseMonitorInfo msg
  /// @return tuple<Got exeption, Error level, Information message, Error message>
  ...
  rclcpp::Subscription<robosense_msgs::msg::RobosenseMonitorInfo>::SharedPtr
    robosense_monitor_info_sub_;
  ...
  void ReceiveMonitorInfoCallback(
    const robosense_msgs::msg::RobosenseMonitorInfo::SharedPtr monitor_info);

  drivers::DeviceCalculateParamsInfo device_info_;
};
