...
private:
  ...
  rclcpp::Publisher<robosense_msgs::msg::RobosenseMonitorInfo>::SharedPtr
    robosense_monitor_info_pub_;

  std::function<void(const drivers::DeviceInfo &)> difop_callback_;
};
