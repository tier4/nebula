...
VelodyneDecoderWrapper::VelodyneDecoderWrapper(rclcpp::Node* const parent_node,
  ...
  , sensor_cfg_(config)
{
  ...
  if (hw_interface_)
  {
    ...
    packets_pub_ =
        parent_node->create_publisher<velodyne_msgs::msg::VelodyneScan>("velodyne_packets", rclcpp::SensorDataQoS());
  }
  ...
  nebula_points_pub_ = parent_node->create_publisher<sensor_msgs::msg::PointCloud2>("velodyne_points", pointcloud_qos);
...
rcl_interfaces::msg::SetParametersResult VelodyneDecoderWrapper::OnParameterChange(const std::vector<rclcpp::Parameter>& p)
{
...
VelodyneDecoderWrapper::get_calibration_result_t
VelodyneDecoderWrapper::GetCalibrationData(const std::string& calibration_file_path)
{
...
void VelodyneDecoderWrapper::ProcessCloudPacket(std::unique_ptr<nebula_msgs::msg::NebulaPacket> packet_msg)
{
...
void VelodyneDecoderWrapper::PublishCloud(std::unique_ptr<sensor_msgs::msg::PointCloud2> pointcloud,
