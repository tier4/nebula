#include "robosense/robosense_ros_offline_extract_bag_pcd.hpp"
...
namespace ros
{
RobosenseRosOfflineExtractBag::RobosenseRosOfflineExtractBag(
...
Status RobosenseRosOfflineExtractBag::InitializeDriver(
...
Status RobosenseRosOfflineExtractBag::GetStatus()
{
  return wrapper_status_;
}

Status RobosenseRosOfflineExtractBag::GetParameters(
  drivers::RobosenseSensorConfiguration & sensor_configuration,
  drivers::RobosenseCalibrationConfiguration & calibration_configuration)
{
  {
...
Status RobosenseRosOfflineExtractBag::ReadBag()
{
      ...
      if (bag_message->topic_name == target_topic) {
        ...
        if (needs_open) {
          ...
          writer_->create_topic(
            {bag_message->topic_name, "robosense_msgs/msg/RobosenseScan",
        ...
        if (skip_num < cnt) {
          ...
          if (only_xyz) {
            ...
            std::cout << "writer.writeBinary((o_dir / fn).string(), cloud_xyz);" << std::endl;
          } else {
