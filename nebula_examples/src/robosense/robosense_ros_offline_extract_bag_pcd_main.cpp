...
int main(int argc, char * argv[])
{
  ...
  std::string node_name = "nebula_robosense_offline_extraction_with_bag";
  ...
  auto robosense_driver =
    std::make_shared<nebula::ros::RobosenseRosOfflineExtractBag>(options, node_name);
  ...
  RCLCPP_INFO_STREAM(rclcpp::get_logger(node_name), "before Reading Started");
