...
#ifndef NEBULA_InnovusionRosOfflineExtractBag_H
#define NEBULA_InnovusionRosOfflineExtractBag_H
...
namespace ros
{
/// @brief Offline innovusion driver usage example (Output PCD data)
class InnovusionRosOfflineExtractBag final : public rclcpp::Node, NebulaDriverRosWrapperBase
{
...
public:
  explicit InnovusionRosOfflineExtractBag(
...
#endif  // NEBULA_InnovusionRosOfflineExtractBag_H
